...
if ((!s.io.eof(s.io_user_data)) != 0) return (int)(0);if (s.read_from_callbacks == 0) return (int)(1);}
			...
			return (int)(s.img_buffer >= s.img_buffer_end);
		}
...
k = (int) (j.spec_start);k <= j.spec_end;}
 else {
...
if (x < 0) return (byte)(0);if (x > 255) return (byte)(255);}
		...
		private static void stbi__idct_block(Pointer<byte> output, int out_stride, Pointer<short> data)
		{
			int i;Pointer<int> val = 64;Pointer<int> v = val;
			Pointer<byte> o;
...
int t0;int t1;int t2;int t3;int p1;int p2;int p3;int p4;int p5;int x0;int x1;int x2;int x3;p2 = (int) (d[16]);p3 = (int) (d[48]);p1 = (int) ((p2 + p3) * ((((0.541196108) * 4096 + 0.5))));t2 = (int) (p1 + p3 * ((((-1.84775901) * 4096 + 0.5))));t3 = (int) (p1 + p2 * ((((0.765366852) * 4096 + 0.5))));p2 = (int) (d[0]);p3 = (int) (d[32]);t0 = (int) (((p2 + p3) << 12));t1 = (int) (((p2 - p3) << 12));x0 = (int) (t0 + t3);x3 = (int) (t0 - t3);x1 = (int) (t1 + t2);x2 = (int) (t1 - t2);t0 = (int) (d[56]);t1 = (int) (d[40]);t2 = (int) (d[24]);t3 = (int) (d[8]);p3 = (int) (t0 + t2);p4 = (int) (t1 + t3);p1 = (int) (t0 + t3);p2 = (int) (t1 + t2);p5 = (int) ((p3 + p4) * ((((1.17587554) * 4096 + 0.5))));t0 = (int) (t0 * ((((0.29863134) * 4096 + 0.5))));t1 = (int) (t1 * ((((2.0531199) * 4096 + 0.5))));t2 = (int) (t2 * ((((3.07271099) * 4096 + 0.5))));t3 = (int) (t3 * ((((1.50132108) * 4096 + 0.5))));p1 = (int) (p5 + p1 * ((((-0.899976193) * 4096 + 0.5))));p2 = (int) (p5 + p2 * ((((-2.56291556) * 4096 + 0.5))));p3 = (int) (p3 * ((((-1.9615705) * 4096 + 0.5))));p4 = (int) (p4 * ((((-0.390180647) * 4096 + 0.5))));t3 += p1 + p4;t2 += p2 + p3;t1 += p2 + p4;t0 += p1 + p3;x0 += 512;x1 += 512;x2 += 512;x3 += 512;v[0] = (int) ((x0 + t3) >> 10);v[56] = (int) ((x0 - t3) >> 10);v[8] = (int) ((x1 + t2) >> 10);v[48] = (int) ((x1 - t2) >> 10);v[16] = (int) ((x2 + t1) >> 10);v[40] = (int) ((x2 - t1) >> 10);v[24] = (int) ((x3 + t0) >> 10);v[32] = (int) ((x3 - t0) >> 10);}
			...
			for (i = (int) (0) , v = val , o = out; i < 8; ++i , v += 8 , o += out_stride){
...
x = (byte) (j.marker);j.marker = (byte) (255);return (byte)(x);}
		...
		private static int stbi__parse_entropy_coded_data(stbi__jpeg z)
		{
			...
			if ((!z.progressive) != 0) {
if (z.scan_n == 1) {
int i;int j;Pointer<short> data = 64;int n = (int)(z.order[0]);int w = (int)((z.img_comp[n].x + 7) >> 3);int h = (int)((z.img_comp[n].y + 7) >> 3);for (j = (int) (0); j < h; ++j){
for (i = (int) (0); i < w; ++i){
...
int i;int j;int k;int x;int y;Pointer<short> data = 64;for (j = (int) (0); j < z.img_mcu_y; ++j){
...
return (int)(L == 0);case 196:L = (int) (stbi__get16be(z.s) - 2);{
Pointer<byte> v;Pointer<int> sizes = 16;int i;int n = (int)(0);int q = (int)(stbi__get8(z.s));int tc = (int)(q >> 4);int th = (int)(q & 15);if (tc > 1 || th > 3) return (int)(stbi__err("bad DHT header"));for (i = (int) (0); i < 16; ++i){
...
int id = (int)(stbi__get8(z.s));int which;int q = (int)(stbi__get8(z.s));for (which = (int) (0); which < z.s.img_n; ++which)if (z.img_comp[which].id == id) break;if (which == z.s.img_n) return (int)(0);z.img_comp[which].hd = (int) (q >> 4);if (z.img_comp[which].hd > 3) return (int)(stbi__err("bad DC huff"));z.img_comp[which].ha = (int) (q & 15);if (z.img_comp[which].ha > 3) return (int)(stbi__err("bad AC huff"));z.order[i] = (int) (which);}
...
Pointer<byte> rgb = { , ,  }z.img_comp[i].id = (int) (stbi__get8(s));if (z.img_comp[i].id != i + 1) if (z.img_comp[i].id != i) {
if (z.img_comp[i].id != rgb[i]) return (int)(stbi__err("bad component ID"));++z.rgb;}
q = (int) (stbi__get8(s));z.img_comp[i].h = (int) ((q >> 4));if ((!z.img_comp[i].h) != 0 || z.img_comp[i].h > 4) return (int)(stbi__err("bad H"));z.img_comp[i].v = (int) (q & 15);if ((!z.img_comp[i].v) != 0 || z.img_comp[i].v > 4) return (int)(stbi__err("bad V"));z.img_comp[i].tq = (int) (stbi__get8(s));if (z.img_comp[i].tq > 3) return (int)(stbi__err("bad TQ"));}
...
m = (int) (stbi__get_marker(j));}
		...
		private static Pointer<byte> stbi__resample_row_v_2(Pointer<byte> output, Pointer<byte> in_near, Pointer<byte> in_far, int w, int hs)
		{
			int i;
			(hs);
			for (i = (int) (0); i < w; ++i)out[i] = (byte) ((((3 * in_near[i] + in_far[i] + 2) >> 2)));
			return out;
		}
		...
		private static Pointer<byte> stbi__resample_row_h_2(Pointer<byte> output, Pointer<byte> in_near, Pointer<byte> in_far, int w, int hs)
		{
			...
			if (w == 1) {
out[0] = (byte) (out[1] = (byte) (input[0]));return out;}

			out[0] = (byte) (input[0]);
			out[1] = (byte) ((((input[0] * 3 + input[1] + 2) >> 2)));
			for (i = (int) (1); i < w - 1; ++i){
int n = (int)(3 * input[i] + 2);out[i * 2 + 0] = (byte) ((((n + input[i - 1]) >> 2)));out[i * 2 + 1] = (byte) ((((n + input[i + 1]) >> 2)));}

			out[i * 2 + 0] = (byte) ((((input[w - 2] * 3 + input[w - 1] + 2) >> 2)));
			out[i * 2 + 1] = (byte) (input[w - 1]);
			(in_far);
			(hs);
			return out;
		}
		...
		private static Pointer<byte> stbi__resample_row_hv_2(Pointer<byte> output, Pointer<byte> in_near, Pointer<byte> in_far, int w, int hs)
		{
			int i;int t0;int t1;
			if (w == 1) {
out[0] = (byte) (out[1] = (byte) ((((3 * in_near[0] + in_far[0] + 2) >> 2))));return out;}

			t1 = (int) (3 * in_near[0] + in_far[0]);
			out[0] = (byte) ((((t1 + 2) >> 2)));
			for (i = (int) (1); i < w; ++i){
t0 = (int) (t1);t1 = (int) (3 * in_near[i] + in_far[i]);out[i * 2 - 1] = (byte) ((((3 * t0 + t1 + 8) >> 4)));out[i * 2] = (byte) ((((3 * t1 + t0 + 8) >> 4)));}
		...
		private static Pointer<byte> stbi__resample_row_generic(Pointer<byte> output, Pointer<byte> in_near, Pointer<byte> in_far, int w, int hs)
		{
			int i;int j;
			(in_far);
			for (i = (int) (0); i < w; ++i)for (j = (int) (0); j < hs; ++j)out[i * hs + j] = (byte) (in_near[i]);
			return out;
		}
...
out[0] = (byte) (r);out[1] = (byte) (g);out[2] = (byte) (b);out[3] = (byte) (255);out += step;}
...
stbi__cleanup_jpeg(z);return (null /*0*/);}
			...
			{
int k;uint i;uint j;Pointer<byte> output;Pointer<Pointer<byte>> coutput = 4;stbi__resample res_comp = 4;for (k = (int) (0); k < decode_n; ++k){
...
out[0] = (byte) (y[i]);out[1] = (byte) (coutput[1][i]);out[2] = (byte) (coutput[2][i]);out[3] = (byte) (255);out += n;}
}
 else {
z.YCbCr_to_RGB_kernel(out, y, coutput[1], coutput[2], z.s.img_x, n);}
}
 else for (i = (uint) (0); i < z.s.img_x; ++i){
out[0] = (byte) (out[1] = (byte) (out[2] = (byte) (y[i])));out[3] = (byte) (255);out += n;}
}
 else {
Pointer<byte> y = coutput[0];if (n == 1) for (i = (uint) (0); i < z.s.img_x; ++i)out[i] = (byte) (y[i]) else for (i = (uint) (0); i < z.s.img_x; ++i)out.GetAndMove() = (byte) (y[i]) , out.GetAndMove() = (byte) (255);}
}
...
stbi__rewind(j.s);return (int)(0);}
		...
		{
			n = (int) (((n & 43690) >> 1) | ((n & 21845) << 1));
			n = (int) (((n & 52428) >> 2) | ((n & 13107) << 2));
			n = (int) (((n & 61680) >> 4) | ((n & 3855) << 4));
			n = (int) (((n & 65280) >> 8) | ((n & 255) << 8));
			return (int)(n);
		}
		...
		{
			int i;int k = (int)(0);
			int code;Pointer<int> next_code = 16;Pointer<int> sizes = 17;
...
++next_code[s];}
		...
		private static int stbi__zhuffman_decode(stbi__zbuf a, stbi__zhuffman z)
		{
			...
			if ((b) != 0) {
s = (int) (b >> 9);a.code_buffer >>= s;a.num_bits -= s;return (int)(b & 511);}
...
--len;}
		...
		{
			Pointer<byte> length_dezigzag = { 16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15 }
			stbi__zhuffman z_codelength = new stbi__zhuffman();
			Pointer<byte> lencodes = 286 + 32 + 137;
			Pointer<byte> codelength_sizes = 19;
			int i;int n;
...
free(a.zout_start);return (null /*0*/);}
		...
		{
			Pointer<byte> png_sig = { 137, 80, 78, 71, 13, 10, 26, 10 }
			int i;
...
cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 4)));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue) & 15));}
if (k > 0) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 4)));}
 else if (depth == 2) {
for (k = (int) (x * img_n); k >= 4; k -= 4 , ++in){
cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 6)));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 4) & 3));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 2) & 3));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue) & 3));}
if (k > 0) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 6)));if (k > 1) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 4) & 3));if (k > 2) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 2) & 3));}
 else if (depth == 1) {
for (k = (int) (x * img_n); k >= 8; k -= 8 , ++in){
cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 7)));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 6) & 1));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 5) & 1));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 4) & 1));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 3) & 1));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 2) & 1));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 1) & 1));cur.GetAndMove() = (byte) (scale * ((in.CurrentValue) & 1));}
if (k > 0) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 7)));if (k > 1) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 6) & 1));if (k > 2) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 5) & 1));if (k > 3) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 4) & 1));if (k > 4) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 3) & 1));if (k > 5) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 2) & 1));if (k > 6) cur.GetAndMove() = (byte) (scale * ((in.CurrentValue >> 1) & 1));}
if (img_n != out_n) {
...
cur16.CurrentValue = (ushort) ((cur[0] << 8) | cur[1]);}
		...
		private static int stbi__create_png_image(stbi__png a, Pointer<byte> image_data, uint image_data_len, int out_n, int depth, int color, int interlaced)
		{
			...
			for (p = (int) (0); p < 7; ++p){
Pointer<int> xorig = { 0, 4, 0, 2, 0, 1, 0 }Pointer<int> yorig = { 0, 0, 4, 0, 2, 0, 1 }Pointer<int> xspc = { 8, 8, 4, 4, 2, 2, 1 }Pointer<int> yspc = { 8, 8, 8, 4, 4, 2, 2 }int i;int j;int x;int y;x = (int) ((a.s.img_x - xorig[p] + xspc[p] - 1) / xspc[p]);y = (int) ((a.s.img_y - yorig[p] + yspc[p] - 1) / yspc[p]);if ((x) != 0 && (y) != 0) {
...
byte t = (byte)(p[0]);p[0] = (byte) (p[2]);p[2] = (byte) (t);p += 4;}
		...
		{
			Pointer<byte> palette = 1024;byte pal_img_n = (byte)(0);
			byte has_trans = (byte)(0);Pointer<byte> tc = 3;
			Pointer<ushort> tc16 = 3;
...
if (info.bpp < 16) psize = (int) ((info.offset - 14 - info.hsz) >> 2);}
			...
			if ((!out) != 0) return (null /*(stbi__err("outofmem") > 0?(null /*0*/):(null /*0*/))*/);
			if (info.bpp < 16) {
int z = (int)(0);if (psize == 0 || psize > 256) {
free(out);return (null /*(stbi__err("invalid") > 0?(null /*0*/):(null /*0*/))*/);}
...
free(out);return (null /*(stbi__err("bad bpp") > 0?(null /*0*/):(null /*0*/))*/);}
pad = (int) ((-width) & 3);for (j = (int) (0); j < s.img_y; ++j){
for (i = (int) (0); i < s.img_x; i += 2){
int v = (int)(stbi__get8(s));int v2 = (int)(0);if (info.bpp == 4) {
v2 = (int) (v & 15);v >>= 4;}
out[z++] = (byte) (pal[v][0]);out[z++] = (byte) (pal[v][1]);out[z++] = (byte) (pal[v][2]);if (target == 4) out[z++] = (byte) (255);if (i + 1 == s.img_x) break;v = (int) ((info.bpp == 8) > 0?stbi__get8(s):v2);out[z++] = (byte) (pal[v][0]);out[z++] = (byte) (pal[v][1]);out[z++] = (byte) (pal[v][2]);if (target == 4) out[z++] = (byte) (255);}
stbi__skip(s, pad);}
}
 else {
int rshift = (int)(0);int gshift = (int)(0);int bshift = (int)(0);int ashift = (int)(0);int rcount = (int)(0);int gcount = (int)(0);int bcount = (int)(0);int acount = (int)(0);int z = (int)(0);int easy = (int)(0);stbi__skip(s, info.offset - 14 - info.hsz);if (info.bpp == 24) width = (int) (3 * s.img_x) else if (info.bpp == 16) width = (int) (2 * s.img_x) else width = (int) (0);pad = (int) ((-width) & 3);if (info.bpp == 24) {
easy = (int) (1);}
 else if (info.bpp == 32) {
if (mb == 255 && mg == 65280 && mr == 16711680 && ma == -16777216) easy = (int) (2);}
if ((!easy) != 0) {
if ((!mr) != 0 || (!mg) != 0 || (!mb) != 0) {
free(out);return (null /*(stbi__err("bad masks") > 0?(null /*0*/):(null /*0*/))*/);}
...
byte a;out[z + 2] = (byte) (stbi__get8(s));out[z + 1] = (byte) (stbi__get8(s));out[z + 0] = (byte) (stbi__get8(s));z += 3;a = (byte) ((easy == 2 > 0?stbi__get8(s):255));all_a |= a;if (target == 4) out[z++] = (byte) (a);}
}
 else {
int bpp = (int)(info.bpp);for (i = (int) (0); i < s.img_x; ++i){
uint v = (uint)((bpp == 16 > 0?stbi__get16le(s):stbi__get32le(s)));int a;out[z++] = (byte) ((((stbi__shiftsigned(v & mr, rshift, rcount)) & 255)));out[z++] = (byte) ((((stbi__shiftsigned(v & mg, gshift, gcount)) & 255)));out[z++] = (byte) ((((stbi__shiftsigned(v & mb, bshift, bcount)) & 255)));a = (int) ((ma > 0?stbi__shiftsigned(v & ma, ashift, acount):255));all_a |= a;if (target == 4) out[z++] = (byte) ((((a) & 255)));}
}
stbi__skip(s, pad);}
}

			if (target == 4 && all_a == 0) for (i = (int) (4 * s.img_x * s.img_y - 1); i >= 0; i -= 4)out[i] = (byte) (255);
			if ((flip_vertically) != 0) {
byte t;for (j = (int) (0); j < s.img_y >> 1; ++j){
Pointer<byte> p1 = out + j * s.img_x * target;Pointer<byte> p2 = out + (s.img_y - 1 - j) * s.img_x * target;for (i = (int) (0); i < s.img_x * target; ++i){
t = (byte) (p1[i]) , p1[i] = (byte) (p2[i]) , p2[i] = (byte) (t);}
}
}

			if ((req_comp) != 0 && req_comp != target) {
out = stbi__convert_format(out, target, req_comp, s.img_x, s.img_y);if (out == (null /*0*/)) return out;}
...
Pointer<byte> p;p = out + channel;if (channel >= channelCount) {
...
for (i = (int) (0); i < pixelCount; i++ , p += 4)p.CurrentValue = (byte) (stbi__get8(s));}
			...
			if (channelCount >= 4) {
for (i = (int) (0); i < w * h; ++i){
Pointer<byte> pixel = out + 4 * i;if (pixel[3] != 0 && pixel[3] != 255) {
...
out = stbi__convert_format(out, 4, req_comp, w, h);if (out == (null /*0*/)) return out;}
...
byte count;Pointer<byte> value = 4;count = (byte) (stbi__get8(s));if ((stbi__at_eof(s)) != 0) return (null /*(stbi__err("bad file") > 0?(null /*0*/):(null /*0*/))*/);if (count > left) count = (byte) (left);if ((!stbi__readval(s, packet.channel, value)) != 0) return 0;for (i = (int) (0); i < count; ++i , dest += 4)stbi__copyval(packet.channel, dest, value);left -= count;}
}
break;case 2:{
int left = (int)(width);{
int count = (int)(stbi__get8(s));int i;if ((stbi__at_eof(s)) != 0) return (null /*(stbi__err("bad file") > 0?(null /*0*/):(null /*0*/))*/);if (count >= 128) {
Pointer<byte> value = 4;if (count == 128) count = (int) (stbi__get16be(s)) else count -= 127;if (count > left) return (null /*(stbi__err("bad file") > 0?(null /*0*/):(null /*0*/))*/);if ((!stbi__readval(s, packet.channel, value)) != 0) return 0;for (i = (int) (0); i < count; ++i , dest += 4)stbi__copyval(packet.channel, dest, value);}
 else {
...
out = stbi__convert_format(out, s.img_n, req_comp, s.img_x, s.img_y);if (out == (null /*0*/)) return out;}
