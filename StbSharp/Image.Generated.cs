...
namespace StbSharp
{
	public static partial class Image
	{
		public class stbi__context
		{
			...
			public Pointer<byte> io_user_data;
		...
		{
			public Pointer<byte> fast = new Pointer<byte>(1 << STBI__ZFAST_BITS);
			public Pointer<ushort> code = new Pointer<ushort>(256);
			public Pointer<byte> values = new Pointer<byte>(256);
			public Pointer<byte> size = new Pointer<byte>(257);
			public Pointer<uint> maxcode = new Pointer<uint>(18);
			public Pointer<int> delta = new Pointer<int>(17);
		}

		public class stbi__zhuffman
		{
			public Pointer<ushort> fast = new Pointer<ushort>(1 << STBI__ZFAST_BITS);
			public Pointer<ushort> firstcode = new Pointer<ushort>(16);
			public Pointer<int> maxcode = new Pointer<int>(17);
			public Pointer<ushort> firstsymbol = new Pointer<ushort>(16);
			public Pointer<byte> size = new Pointer<byte>(288);
			public Pointer<ushort> value = new Pointer<ushort>(288);
		}

		public class stbi__zbuf
		{
		...
		static float stbi__h2l_gamma_i = (float) (1.0f/2.2f);
		static float stbi__h2l_scale_i = (float) (1.0f);

		static Pointer<uint> stbi__bmask =
			new Pointer<uint>(new uint[]
			{
		...
		static Pointer<byte> stbi__depth_scale_table =
			new Pointer<byte>(new byte[]
		...
		public static void stbi__start_mem(stbi__context s, Pointer<byte> buffer, int len)
		{
			s.io.read = null;
			s.read_from_callbacks = (int) (0);
			s.img_buffer = s.img_buffer_original = buffer;
			s.img_buffer_end = s.img_buffer_original_end = buffer.Plus(len);
		}

		public static void stbi__start_callbacks(stbi__context s, stbi_io_callbacks c, Pointer<byte> user)
		{
		...
		public static Pointer<byte> stbi__load_main(stbi__context s, Pointer<int> x, Pointer<int> y, Pointer<int> comp,
			int req_comp)
		{
			...
			return (((stbi__err("unknown image type")) > 0 ? Pointer<byte>.Null : Pointer<byte>.Null));
		}

		public static Pointer<byte> stbi__load_flip(stbi__context s, Pointer<int> x, Pointer<int> y, Pointer<int> comp,
			int req_comp)
		{
			Pointer<byte> result = stbi__load_main(s, x, y, comp, (int) (req_comp));
			if ((stbi__vertically_flip_on_load) != 0 && !result.IsNull)
			{
		...
		public static Pointer<byte> stbi_load_from_memory(Pointer<byte> buffer, int len, Pointer<int> x, Pointer<int> y,
		...
		public static Pointer<byte> stbi_load_from_callbacks(stbi_io_callbacks clbk, Pointer<byte> user, Pointer<int> x,
		...
		{
			int n = (int) (s.io.read(s.io_user_data, s.buffer_start.Cast<sbyte>(), (int) (s.buflen)));
			if (n == 0)
			{
				s.read_from_callbacks = (int) (0);
				s.img_buffer = s.buffer_start;
				s.img_buffer_end = s.buffer_start.Plus(1);
				s.img_buffer.CurrentValue = (byte) (0);
			}
			else
			{
				s.img_buffer = s.buffer_start;
				s.img_buffer_end = s.buffer_start.Plus(n);
			}
		...
		{
			if (s.img_buffer.Lesser(s.img_buffer_end)) return (byte) (s.img_buffer.GetAndMove());
		...
		public static int stbi__at_eof(stbi__context s)
		{
			...
			return (int) (s.img_buffer.GreaterEqual(s.img_buffer_end) ? 1 : 0);
		}
		...
		public static void stbi__skip(stbi__context s, int n)
		{
			...
			if ((s.io.read) != null)
			{
				int blen = (int) ((s.img_buffer_end.Minus(s.img_buffer)));
				if (blen < n)
				{
					s.img_buffer = s.img_buffer_end;
			...
			s.img_buffer.PlusAssign(n);
		}

		public static int stbi__getn(stbi__context s, Pointer<byte> buffer, int n)
		{
			if ((s.io.read) != null)
			{
				int blen = (int) ((s.img_buffer_end.Minus(s.img_buffer)));
				if (blen < n)
				{
					...
					count = (int) (s.io.read(s.io_user_data, buffer.Cast<sbyte>().Plus(blen), (int) (n - blen)));
			...
			if (s.img_buffer.Plus(n).LesserEqual(s.img_buffer_end))
			{
		...
		public static Pointer<byte> stbi__convert_format(Pointer<byte> data, int img_n, int req_comp, uint x, uint y)
		{
			int i;
			int j;
			Pointer<byte> good;
			if (req_comp == img_n) return data;
			good = stbi__malloc((ulong) (req_comp*x*y)).Cast<byte>();
			if (good.Equals((null)))
			{
				free(data);
				return (((stbi__err("outofmem")) > 0 ? Pointer<byte>.Null : Pointer<byte>.Null));
			}

			for (j = (int) (0); j < y; ++j)
			{
				{
					Pointer<byte> src = data.Plus(j*x*img_n);
					Pointer<byte> dest = good.Plus(j*x*req_comp);
					switch (((int) (img_n)*8 + (int) (req_comp)))
					{
						case ((int) (1)*8 + (int) (2)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(1) , dest.PlusAssign(2))
							{
								dest[0] = (byte) (src[0]);
								dest[1] = (byte) (255);
							}
							break;
						case ((int) (1)*8 + (int) (3)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(1) , dest.PlusAssign(3))
							{
								dest[0] = (byte) (dest[1] = (byte) (dest[2] = (byte) (src[0])));
							}
							break;
						case ((int) (1)*8 + (int) (4)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(1) , dest.PlusAssign(4))
							{
								dest[0] = (byte) (dest[1] = (byte) (dest[2] = (byte) (src[0])));
								dest[3] = (byte) (255);
							}
							break;
						case ((int) (2)*8 + (int) (1)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(2) , dest.PlusAssign(1))
							{
								dest[0] = (byte) (src[0]);
							}
							break;
						case ((int) (2)*8 + (int) (3)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(2) , dest.PlusAssign(3))
							{
								dest[0] = (byte) (dest[1] = (byte) (dest[2] = (byte) (src[0])));
							}
							break;
						case ((int) (2)*8 + (int) (4)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(2) , dest.PlusAssign(4))
							{
								dest[0] = (byte) (dest[1] = (byte) (dest[2] = (byte) (src[0])));
								dest[3] = (byte) (src[1]);
							}
							break;
						case ((int) (3)*8 + (int) (4)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(3) , dest.PlusAssign(4))
							{
								dest[0] = (byte) (src[0]);
								dest[1] = (byte) (src[1]);
								dest[2] = (byte) (src[2]);
							...
							break;
						case ((int) (3)*8 + (int) (1)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(3) , dest.PlusAssign(1))
							{
								dest[0] = (byte) (stbi__compute_y((int) (src[0]), (int) (src[1]), (int) (src[2])));
							}
							break;
						case ((int) (3)*8 + (int) (2)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(3) , dest.PlusAssign(2))
							{
								dest[0] = (byte) (stbi__compute_y((int) (src[0]), (int) (src[1]), (int) (src[2])));
								dest[1] = (byte) (255);
							}
							break;
						case ((int) (4)*8 + (int) (1)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(4) , dest.PlusAssign(1))
							{
								dest[0] = (byte) (stbi__compute_y((int) (src[0]), (int) (src[1]), (int) (src[2])));
							}
							break;
						case ((int) (4)*8 + (int) (2)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(4) , dest.PlusAssign(2))
							{
								dest[0] = (byte) (stbi__compute_y((int) (src[0]), (int) (src[1]), (int) (src[2])));
								dest[1] = (byte) (src[3]);
							}
							break;
						case ((int) (4)*8 + (int) (3)):
							for (i = (int) (x - 1); i >= 0; --i , src.PlusAssign(4) , dest.PlusAssign(3))
							{
								dest[0] = (byte) (src[0]);
								dest[1] = (byte) (src[1]);
								dest[2] = (byte) (src[2]);
		...
		public static int stbi__build_huffman(stbi__huffman h, Pointer<int> count)
		{
			int i;
			int j;
			int k = (int) (0);
		...
		public static void stbi__build_fast_ac(Pointer<short> fast_ac, stbi__huffman h)
		{
			int i;
			for (i = (int) (0); i < (1 << 9); ++i)
			{
		...
		public static int stbi__jpeg_decode_block(stbi__jpeg j, Pointer<short> data, stbi__huffman hdc, stbi__huffman hac,
		...
		public static int stbi__jpeg_decode_block_prog_dc(stbi__jpeg j, Pointer<short> data, stbi__huffman hdc, int b)
		{
			int diff;
			int dc;
			int t;
		...
		public static int stbi__jpeg_decode_block_prog_ac(stbi__jpeg j, Pointer<short> data, stbi__huffman hac,
			Pointer<short> fac)
		{
			int k;
			...
			else
			{
				...
				if ((j.eob_run) != 0)
				{
					...
					{
						{
							Pointer<short> p = data.Plus(stbi__jpeg_dezigzag[k]);
							if (p.CurrentValue != 0)
								if ((stbi__jpeg_get_bit(j)) != 0)
									if ((p.CurrentValue & bit) == 0)
									{
										if (p.CurrentValue > 0) p.CurrentValue += (short) (bit);
										else p.CurrentValue -= (short) (bit);
									}
						}
					}
				}
		...
		public static void stbi__idct_block(Pointer<byte> _out_, int out_stride, Pointer<short> data)
		{
			int i;
			...
			for (i = (int) (0); i < 8; ++i , d.Move() , v.Move())
			{
				{
			...
			for (i = (int) (0) , v = val , o = _out_; i < 8; ++i , v.PlusAssign(8) , o.PlusAssign(out_stride))
			{
				{
					int t0;
					int t1;
							...
							{
								{
									...
									z.idct_block_kernel(z.img_comp[n].data.Plus(z.img_comp[n].w2*j*8).Plus(i*8), (int) (z.img_comp[n].w2), data);
									if (--z.todo <= 0)
									{
													...
													{
														{
															...
															if (
																stbi__jpeg_decode_block(z, data, z.huff_dc[z.img_comp[n].hd], z.huff_ac[ha], z.fast_ac[ha], (int) (n),
																	z.dequant[z.img_comp[n].tq]) == 0) return (int) (0);
															z.idct_block_kernel(z.img_comp[n].data.Plus(z.img_comp[n].w2*y2).Plus(x2), (int) (z.img_comp[n].w2), data);
														}
													}
												}
											}
					...
					{
						{
							...
							{
								{
									Pointer<short> data = z.img_comp[n].coeff.Plus(64*(i + j*z.img_comp[n].coeff_w));
									if (z.spec_start == 0)
									{
													...
													{
														{
															...
															Pointer<short> data = z.img_comp[n].coeff.Plus(64*(x2 + y2*z.img_comp[n].coeff_w));
		...
		public static void stbi__jpeg_dequantize(Pointer<short> data, Pointer<byte> dequant)
		{
			int i;
			for (i = (int) (0); i < 64; ++i)
			{
		...
		public static int stbi__process_frame_header(stbi__jpeg z, int scan)
		{
			...
			{
				{
					z.img_comp[i].data = Pointer<byte>.Null;
					z.img_comp[i].linebuf = Pointer<byte>.Null;
				}
			}
			...
			{
				{
					Pointer<byte> rgb = new Pointer<byte>(new byte[] {(byte) 'R', (byte) 'G', (byte) 'B'});
			...
			{
				{
					...
					if (z.img_comp[i].raw_data.Equals((null)))
					{
						for (--i; i >= 0; --i)
						{
							{
								free(z.img_comp[i].raw_data);
								z.img_comp[i].raw_data = Pointer<byte>.Null;
							}
						}
						return (int) (stbi__err("outofmem"));
					}
					z.img_comp[i].data = z.img_comp[i].raw_data;
					z.img_comp[i].linebuf = Pointer<byte>.Null;
					if ((z.progressive) != 0)
					{
						...
						z.img_comp[i].coeff = z.img_comp[i].raw_coeff.Cast<short>();
					}
					else
					{
						z.img_comp[i].coeff = Pointer<short>.Null;
						z.img_comp[i].raw_coeff = Pointer<byte>.Null;
					}
				}
			}
			return (int) (1);
		...
		public static int stbi__decode_jpeg_image(stbi__jpeg j)
		{
			...
			{
				{
					j.img_comp[m].raw_data = Pointer<byte>.Null;
					j.img_comp[m].raw_coeff = Pointer<byte>.Null;
				}
			}
		...
		public static Pointer<byte> resample_row_1(Pointer<byte> _out_, Pointer<byte> in_near, Pointer<byte> in_far, int w,
			int hs)
		{
			return in_near;
		}

		public static Pointer<byte> stbi__resample_row_v_2(Pointer<byte> _out_, Pointer<byte> in_near, Pointer<byte> in_far,
			int w, int hs)
		{
			int i;
			for (i = (int) (0); i < w; ++i)
		...
		public static Pointer<byte> stbi__resample_row_h_2(Pointer<byte> _out_, Pointer<byte> in_near, Pointer<byte> in_far,
			int w, int hs)
		{
			int i;
		...
		public static Pointer<byte> stbi__resample_row_hv_2(Pointer<byte> _out_, Pointer<byte> in_near, Pointer<byte> in_far,
			int w, int hs)
		{
			int i;
			int t0;
		...
		public static Pointer<byte> stbi__resample_row_generic(Pointer<byte> _out_, Pointer<byte> in_near,
		...
		public static void stbi__YCbCr_to_RGB_row(Pointer<byte> _out_, Pointer<byte> y, Pointer<byte> pcb, Pointer<byte> pcr,
			int count, int step)
		{
			int i;
		...
		public static void stbi__cleanup_jpeg(stbi__jpeg j)
		{
			...
			{
				{
					if (!(j.img_comp[i].raw_data).IsNull)
					{
						free(j.img_comp[i].raw_data);
						j.img_comp[i].raw_data = Pointer<byte>.Null;
						j.img_comp[i].data = Pointer<byte>.Null;
					}
					if (!(j.img_comp[i].raw_coeff).IsNull)
					{
						free(j.img_comp[i].raw_coeff);
						j.img_comp[i].raw_coeff = Pointer<byte>.Null;
						j.img_comp[i].coeff = Pointer<short>.Null;
					}
					if (!j.img_comp[i].linebuf.IsNull)
					{
						free(j.img_comp[i].linebuf);
						j.img_comp[i].linebuf = Pointer<byte>.Null;
					}
				}
			}
		}

		public static Pointer<byte> load_jpeg_image(stbi__jpeg z, Pointer<int> out_x, Pointer<int> out_y, Pointer<int> comp,
			int req_comp)
		{
			int n;
			int decode_n;
			...
			if (req_comp < 0 || req_comp > 4)
				return (((stbi__err("bad req_comp")) > 0 ? Pointer<byte>.Null : Pointer<byte>.Null));
			...
			else decode_n = (int) (z.s.img_n);
			{
				...
				Pointer<stbi__resample > res_comp = new Pointer<stbi__resample>(4);
				for (i = 0; i < res_comp.Size; ++i)
				{
					res_comp[i] = new stbi__resample();
				}
				...
				{
					{
						...
						z.img_comp[k].linebuf = stbi__malloc((ulong) (z.s.img_x + 3)).Cast<byte>();
						if (z.img_comp[k].linebuf.IsNull)
						{
							stbi__cleanup_jpeg(z);
							return (((stbi__err("outofmem")) > 0 ? Pointer<byte>.Null : Pointer<byte>.Null));
						}
				...
				output = stbi__malloc((ulong) (n*z.s.img_x*z.s.img_y + 1)).Cast<byte>();
				if (output.IsNull)
				{
					stbi__cleanup_jpeg(z);
					return (((stbi__err("outofmem")) > 0 ? Pointer<byte>.Null : Pointer<byte>.Null));
				...
				{
					{
						Pointer<byte> _out_ = output.Plus(n*z.s.img_x*j);
						for (k = (int) (0); k < decode_n; ++k)
						{
							{
								stbi__resample r = res_comp[k];
								...
								if (++r.ystep >= r.vs)
								{
									r.ystep = (int) (0);
									r.line0 = r.line1;
									if (++r.ypos < z.img_comp[k].y) r.line1.PlusAssign(z.img_comp[k].w2);
								}
							}
						}
						if (n >= 3)
						...
						else
						{
							...
							if (n == 1)
								...
								for (i = (uint) (0); i < z.s.img_x; ++i)
								{
									_out_.SetAndMove((byte) (y[i]));
									;
									_out_.SetAndMove((byte) (255));
								}
						}
					}
				}
				...
				if (!comp.IsNull) comp.CurrentValue = (int) (z.s.img_n);
				return output;
			}

		}

		public static Pointer<byte> stbi__jpeg_load(stbi__context s, Pointer<int> x, Pointer<int> y, Pointer<int> comp,
			int req_comp)
		{
			Pointer<byte> result;
		...
		public static int stbi__jpeg_info_raw(stbi__jpeg j, Pointer<int> x, Pointer<int> y, Pointer<int> comp)
		{
			...
			if (!x.IsNull) x.CurrentValue = (int) (j.s.img_x);
			if (!y.IsNull) y.CurrentValue = (int) (j.s.img_y);
			if (!comp.IsNull) comp.CurrentValue = (int) (j.s.img_n);
			return (int) (1);
		}

		public static int stbi__jpeg_info(stbi__context s, Pointer<int> x, Pointer<int> y, Pointer<int> comp)
		{
			int result;
			stbi__jpeg j = new stbi__jpeg();
			j.s = s;
		...
		public static int stbi__zbuild_huffman(stbi__zhuffman z, Pointer<byte> sizelist, int num)
		{
			int i;
			int k = (int) (0);
			int code;
			...
			memset(sizes, (int) (0), (ulong) ((sizes).Size));
			memset(z.fast, (int) (0), (ulong) ((z.fast).Size));
			for (i = (int) (0); i < num; ++i)
			{
				++sizes[sizelist[i]];
			}
		...
		{
			if (z.zbuffer.GreaterEqual(z.zbuffer_end)) return (byte) (0);
		...
		public static int stbi__zexpand(stbi__zbuf z, Pointer<sbyte> zout, int n)
		{
			Pointer<sbyte> q;
			int cur;
			int limit;
			...
			cur = (int) ((z.zout.Minus(z.zout_start)));
			limit = (int) (old_limit = (int) ((z.zout_end.Minus(z.zout_start))));
			while (cur + n > limit)
			{
				limit *= (int) (2);
			}
			q = realloc(z.zout_start, (ulong) (limit)).Cast<sbyte>();
			if (q.Equals((null))) return (int) (stbi__err("outofmem"));
			z.zout_start = q;
			z.zout = q.Plus(cur);
			z.zout_end = q.Plus(limit);
			return (int) (1);
		}
			...
			{
				{
					...
					if (z < 256)
					{
						...
						if (zout.GreaterEqual(a.zout_end))
						{
							if (stbi__zexpand(a, zout, (int) (1)) == 0) return (int) (0);
							zout = a.zout;
						}
						zout.SetAndMove((sbyte) (z));
					}
					else
					{
						Pointer<byte> p;
						...
						if (zout.Minus(a.zout_start) < dist) return (int) (stbi__err("bad dist"));
						if (zout.Plus(len).Greater(a.zout_end))
						{
							if (stbi__zexpand(a, zout, (int) (len)) == 0) return (int) (0);
							zout = a.zout;
						}
						p = (zout.Minus(dist)).Cast<byte>();
						if (dist == 1)
						{
						...
						else
						{
							if ((len) != 0)
							{
								do
								{
									zout.SetAndMove((sbyte) (p.GetAndMove()));
								} while ((--len) != 0);
							}
						}
					}
		...
		public static int stbi__compute_huffman_codes(stbi__zbuf a)
		{
			...
			Pointer<byte> lencodes = new Pointer<byte>(286 + 32 + 137);
			...
			memset(codelength_sizes, (int) (0), (ulong) ((codelength_sizes).Size));
			...
			{
				{
					...
					else if (c == 16)
					{
						...
						memset(lencodes.Plus(n), (int) (lencodes[n - 1]), (ulong) (c));
						n += (int) (c);
					}
					else if (c == 17)
					{
						c = (int) (stbi__zreceive(a, (int) (3)) + 3);
						memset(lencodes.Plus(n), (int) (0), (ulong) (c));
						n += (int) (c);
					}
					else
					{
			...
			if (stbi__zbuild_huffman(a.z_distance, lencodes.Plus(hlit), (int) (hdist)) == 0) return (int) (0);
			return (int) (1);
		}
		...
		public static int stbi__parse_uncompressed_block(stbi__zbuf a)
		{
			...
			if (a.zbuffer.Plus(len).Greater(a.zbuffer_end)) return (int) (stbi__err("read past buffer"));
			if (a.zout.Plus(len).Greater(a.zout_end)) if (stbi__zexpand(a, a.zout, (int) (len)) == 0) return (int) (0);
			memcpy(a.zout, a.zbuffer, (ulong) (len));
			a.zbuffer.PlusAssign(len);
			a.zout.PlusAssign(len);
			return (int) (1);
		}
		...
		public static int stbi__do_zlib(stbi__zbuf a, Pointer<sbyte> obuf, int olen, int exp, int parse_header)
		{
			a.zout_start = obuf;
			a.zout = obuf;
			a.zout_end = obuf.Plus(olen);
			a.z_expandable = (int) (exp);
			return (int) (stbi__parse_zlib(a, (int) (parse_header)));
		}

		public static Pointer<sbyte> stbi_zlib_decode_malloc_guesssize(Pointer<sbyte> buffer, int len, int initial_size,
			Pointer<int> outlen)
		{
			stbi__zbuf a = new stbi__zbuf();
			Pointer<sbyte> p = stbi__malloc((ulong) (initial_size)).Cast<sbyte>();
			if (p.Equals((null))) return Pointer<sbyte>.Null;
			a.zbuffer = buffer.Cast<byte>();
			a.zbuffer_end = buffer.Cast<byte>().Plus(len);
			if ((stbi__do_zlib(a, p, (int) (initial_size), (int) (1), (int) (1))) != 0)
			{
				if (!outlen.IsNull) outlen.CurrentValue = (int) ((a.zout.Minus(a.zout_start)));
				return a.zout_start;
			}
			else
			{
				free(a.zout_start);
				return Pointer<sbyte>.Null;
			}

		}

		public static Pointer<sbyte> stbi_zlib_decode_malloc(Pointer<sbyte> buffer, int len, Pointer<int> outlen)
		{
			return stbi_zlib_decode_malloc_guesssize(buffer, (int) (len), (int) (16384), outlen);
		}

		public static Pointer<sbyte> stbi_zlib_decode_malloc_guesssize_headerflag(Pointer<sbyte> buffer, int len,
		...
		public static int stbi_zlib_decode_buffer(Pointer<sbyte> obuffer, int olen, Pointer<sbyte> ibuffer, int ilen)
		{
			stbi__zbuf a = new stbi__zbuf();
			a.zbuffer = ibuffer.Cast<byte>();
			a.zbuffer_end = ibuffer.Cast<byte>().Plus(ilen);
			if ((stbi__do_zlib(a, obuffer, (int) (olen), (int) (0), (int) (1))) != 0)
				return (int) ((a.zout.Minus(a.zout_start)));
			else return (int) (-1);
		}

		public static Pointer<sbyte> stbi_zlib_decode_noheader_malloc(Pointer<sbyte> buffer, int len, Pointer<int> outlen)
		{
			stbi__zbuf a = new stbi__zbuf();
			Pointer<sbyte> p = stbi__malloc((ulong) (16384)).Cast<sbyte>();
			if (p.Equals((null))) return Pointer<sbyte>.Null;
			a.zbuffer = buffer.Cast<byte>();
			a.zbuffer_end = buffer.Cast<byte>().Plus(len);
		...
		public static int stbi_zlib_decode_noheader_buffer(Pointer<sbyte> obuffer, int olen, Pointer<sbyte> ibuffer, int ilen)
		{
			stbi__zbuf a = new stbi__zbuf();
			a.zbuffer = ibuffer.Cast<byte>();
			a.zbuffer_end = ibuffer.Cast<byte>().Plus(ilen);
		...
		public static int stbi__create_png_image_raw(stbi__png a, Pointer<byte> raw, uint raw_len, int out_n, uint x, uint y,
			int depth, int color)
		{
			...
			int width = (int) (x);
			a._out_ = stbi__malloc((ulong) (x*y*output_bytes)).Cast<byte>();
			if (a._out_.IsNull) return (int) (stbi__err("outofmem"));
			...
			{
				{
					Pointer<byte> cur = a._out_.Plus(stride*j);
					Pointer<byte> prior = cur.Minus(stride);
					int filter = (int) (raw.GetAndMove());
					if (filter > 4) return (int) (stbi__err("invalid filter"));
					if (depth < 8)
					{
						;
						cur.PlusAssign(x*out_n - img_width_bytes);
						filter_bytes = (int) (1);
					...
					if (depth == 8)
					{
						...
						raw.PlusAssign(img_n);
						cur.PlusAssign(out_n);
						prior.PlusAssign(out_n);
					}
					else if (depth == 16)
					{
						if (img_n != out_n)
						...
						raw.PlusAssign(filter_bytes);
						cur.PlusAssign(output_bytes);
						prior.PlusAssign(output_bytes);
					}
					else
					{
						raw.PlusAssign(1);
					...
					else
					{
						...
						switch (filter)
						{
							case STBI__F_none:
								for (i = (uint) (x - 1);
									i >= 1;
									--i , cur[filter_bytes] = (byte) (255) , raw.PlusAssign(filter_bytes) , cur.PlusAssign(output_bytes) ,
										prior.PlusAssign(output_bytes))
								{
									for (k = (int) (0); k < filter_bytes; ++k)
									{
						...
						if (depth == 16)
						{
							cur = a._out_.Plus(stride*j);
							for (i = (uint) (0); i < x; ++i , cur.PlusAssign(output_bytes))
							{
								{
									cur[filter_bytes + 1] = (byte) (255);
								}
			...
			if (depth < 8)
			{
				for (j = (uint) (0); j < y; ++j)
				{
					{
						Pointer<byte> cur = a._out_.Plus(stride*j);
						Pointer<byte> _in_ = a._out_.Plus(stride*j).Plus(x*out_n).Minus(img_width_bytes);
						byte scale = (byte) ((color == 0) ? stbi__depth_scale_table[depth] : 1);
						if (depth == 4)
						{
							for (k = (int) (x*img_n); k >= 2; k -= (int) (2) , _in_.Move())
							{
								{
									cur.SetAndMove((byte) (scale*(int) ((_in_.CurrentValue >> 4))));
									cur.SetAndMove((byte) (scale*((byte) (_in_.CurrentValue) & 0x0f)));
								}
							}
							if (k > 0) cur.SetAndMove((byte) (scale*(int) ((_in_.CurrentValue >> 4))));
						}
						else if (depth == 2)
						{
							for (k = (int) (x*img_n); k >= 4; k -= (int) (4) , _in_.Move())
							{
								{
									cur.SetAndMove((byte) (scale*(int) ((_in_.CurrentValue >> 6))));
									cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 4) & 0x03)));
									cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 2) & 0x03)));
									cur.SetAndMove((byte) (scale*((byte) (_in_.CurrentValue) & 0x03)));
								}
							}
							if (k > 0) cur.SetAndMove((byte) (scale*(int) ((_in_.CurrentValue >> 6))));
							if (k > 1) cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 4) & 0x03)));
							if (k > 2) cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 2) & 0x03)));
						}
						else if (depth == 1)
						{
							for (k = (int) (x*img_n); k >= 8; k -= (int) (8) , _in_.Move())
							{
								{
									cur.SetAndMove((byte) (scale*(int) ((_in_.CurrentValue >> 7))));
									cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 6) & 0x01)));
									cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 5) & 0x01)));
									cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 4) & 0x01)));
									cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 3) & 0x01)));
									cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 2) & 0x01)));
									cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 1) & 0x01)));
									cur.SetAndMove((byte) (scale*((byte) (_in_.CurrentValue) & 0x01)));
								}
							}
							if (k > 0) cur.SetAndMove((byte) (scale*(int) ((_in_.CurrentValue >> 7))));
							if (k > 1) cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 6) & 0x01)));
							if (k > 2) cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 5) & 0x01)));
							if (k > 3) cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 4) & 0x01)));
							if (k > 4) cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 3) & 0x01)));
							if (k > 5) cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 2) & 0x01)));
							if (k > 6) cur.SetAndMove((byte) (scale*((_in_.CurrentValue >> 1) & 0x01)));
						}
						if (img_n != out_n)
						{
							int q;
			...
			{
				Pointer<byte> cur = a._out_;
				Pointer<ushort> cur16 = cur.Cast<ushort>();
				for (i = (uint) (0); i < x*y*out_n; ++i , cur16.Move() , cur.PlusAssign(2))
				{
					{
		...
		public static int stbi__create_png_image(stbi__png a, Pointer<byte> image_data, uint image_data_len, int out_n,
			int depth, int color, int interlaced)
		{
			...
			final = stbi__malloc((ulong) (a.s.img_x*a.s.img_y*out_n)).Cast<byte>();
			for (p = (int) (0); p < 7; ++p)
			{
				{
					Pointer<int> xorig = new Pointer<int>(new int[] {(int) 0, (int) 4, (int) 0, (int) 2, (int) 0, (int) 1, (int) 0});
					Pointer<int> yorig = new Pointer<int>(new int[] {(int) 0, (int) 0, (int) 4, (int) 0, (int) 2, (int) 0, (int) 1});
					Pointer<int> xspc = new Pointer<int>(new int[] {(int) 8, (int) 8, (int) 4, (int) 4, (int) 2, (int) 2, (int) 1});
					Pointer<int> yspc = new Pointer<int>(new int[] {(int) 8, (int) 8, (int) 8, (int) 4, (int) 4, (int) 2, (int) 2});
					int i;
					int j;
					int x;
					int y;
								...
								{
									{
										...
										memcpy(final.Plus(out_y*a.s.img_x*out_n).Plus(out_x*out_n), a._out_.Plus((j*x + i)*out_n), (ulong) (out_n));
									}
								}
							}
						}
						free(a._out_);
						image_data.PlusAssign(img_len);
		...
		public static int stbi__compute_transparency(stbi__png z, Pointer<byte> tc, int out_n)
		{
			stbi__context s = z.s;
			uint i;
			uint pixel_count = (uint) (s.img_x*s.img_y);
			Pointer<byte> p = z._out_;
			if (out_n == 2)
			{
		...
		public static int stbi__compute_transparency16(stbi__png z, Pointer<ushort> tc, int out_n)
		{
			stbi__context s = z.s;
			uint i;
			uint pixel_count = (uint) (s.img_x*s.img_y);
			Pointer<ushort> p = z._out_.Cast<ushort>();
			if (out_n == 2)
			{
				for (i = (uint) (0); i < pixel_count; ++i)
				{
		...
		public static int stbi__expand_png_palette(stbi__png a, Pointer<byte> palette, int len, int pal_img_n)
		{
			uint i;
			uint pixel_count = (uint) (a.s.img_x*a.s.img_y);
			Pointer<byte> p;
			Pointer<byte> temp_out;
			Pointer<byte> orig = a._out_;
			p = stbi__malloc((ulong) (pixel_count*pal_img_n)).Cast<byte>();
			if (p.Equals((null))) return (int) (stbi__err("outofmem"));
			temp_out = p;
			if (pal_img_n == 3)
			{
				for (i = (uint) (0); i < pixel_count; ++i)
		...
		public static int stbi__reduce_png(stbi__png p)
		{
			...
			Pointer<ushort> orig = p._out_.Cast<ushort>();
			if (p.depth != 16) return (int) (1);
			reduced = stbi__malloc((ulong) (img_len)).Cast<byte>();
		...
		public static int stbi__parse_png_file(stbi__png z, int scan, int req_comp)
		{
			...
			int is_iphone = (int) (0);
			stbi__context s = z.s;
			z.expanded = Pointer<byte>.Null;
			z.idata = Pointer<byte>.Null;
			z._out_ = Pointer<byte>.Null;
			...
			{
				{
					...
					switch (c.type)
					{
						...
						{
							if ((first) != 0) return (int) (stbi__err("first not IHDR"));
							if (!z.idata.IsNull) return (int) (stbi__err("tRNS after IDAT"));
							if ((pal_img_n) != 0)
							{
						...
						case (((int) ('I') << 24) + ((int) ('D') << 16) + ((int) ('A') << 8) + (int) ('T')):
						{
							...
							if (ioff + c.length > idata_limit)
							{
								...
								;
								p = realloc(z.idata, (ulong) (idata_limit)).Cast<byte>();
								if (p.Equals((null))) return (int) (stbi__err("outofmem"));
								z.idata = p;
							}
							if (stbi__getn(s, z.idata.Plus(ioff), (int) (c.length)) == 0) return (int) (stbi__err("outofdata"));
							ioff += (uint) (c.length);
							break;
						}
						case (((int) ('I') << 24) + ((int) ('E') << 16) + ((int) ('N') << 8) + (int) ('D')):
						{
							...
							if ((first) != 0) return (int) (stbi__err("first not IHDR"));
							if (scan != STBI__SCAN_load) return (int) (1);
							if (z.idata.Equals((null))) return (int) (stbi__err("no IDAT"));
							bpl = (uint) ((s.img_x*z.depth + 7)/8);
							raw_len = (uint) (bpl*s.img_y*s.img_n + s.img_y);
							z.expanded =
								stbi_zlib_decode_malloc_guesssize_headerflag(z.idata.Cast<sbyte>(), (int) (ioff), (int) (raw_len),
								new Pointer<int>(raw_len), is_iphone>0?0:1).Cast<byte>();
							if (z.expanded.Equals((null))) return (int) (0);
							free(z.idata);
							z.idata = Pointer<byte>.Null;
...
/*								invalid_chunk[0] = (sbyte) ((byte) (((c.type >> 24) & 255)));
		...
		public static Pointer<byte> stbi__do_png(stbi__png p, Pointer<int> x, Pointer<int> y, Pointer<int> n, int req_comp)
		{
			Pointer<byte> result = Pointer<byte>.Null;
			if (req_comp < 0 || req_comp > 4)
				return (((stbi__err("bad req_comp")) > 0 ? Pointer<byte>.Null : Pointer<byte>.Null));
			if ((stbi__parse_png_file(p, (int) (STBI__SCAN_load), (int) (req_comp))) != 0)
			{
				...
				if (!n.IsNull) n.CurrentValue = (int) (p.s.img_n);
			}

			free(p._out_);
			p._out_ = Pointer<byte>.Null;
			free(p.expanded);
			p.expanded = Pointer<byte>.Null;
			free(p.idata);
			p.idata = Pointer<byte>.Null;
			return result;
		}

		public static Pointer<byte> stbi__png_load(stbi__context s, Pointer<int> x, Pointer<int> y, Pointer<int> comp,
			int req_comp)
		{
		...
		public static int stbi__png_info_raw(stbi__png p, Pointer<int> x, Pointer<int> y, Pointer<int> comp)
		{
			...
			if (!x.IsNull) x.CurrentValue = (int) (p.s.img_x);
			if (!y.IsNull) y.CurrentValue = (int) (p.s.img_y);
			if (!comp.IsNull) comp.CurrentValue = (int) (p.s.img_n);
			return (int) (1);
		}

		public static int stbi__png_info(stbi__context s, Pointer<int> x, Pointer<int> y, Pointer<int> comp)
		{
			stbi__png p = new stbi__png();
			p.s = s;
		...
		public static int stbi__info_main(stbi__context s, Pointer<int> x, Pointer<int> y, Pointer<int> comp)
		{
		...
		public static int stbi_info_from_memory(Pointer<byte> buffer, int len, Pointer<int> x, Pointer<int> y,
			Pointer<int> comp)
		{
			stbi__context s = new stbi__context();
			stbi__start_mem(s, buffer, (int) (len));
		...
		public static int stbi_info_from_callbacks(stbi_io_callbacks c, Pointer<byte> user, Pointer<int> x, Pointer<int> y,
			Pointer<int> comp)
		{
			stbi__context s = new stbi__context();
