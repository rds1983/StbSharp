...
namespace StbSharp
{
	unsafe partial class StbTrueType
	{
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt_bakedchar
		{
			public ushort x0;
			public ushort y0;
			public ushort x1;
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt_packedchar
		{
			public ushort x0;
			public ushort y0;
			public ushort x1;
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt_vertex
		{
			public short x;
			public short y;
			public short cx;
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt__csctx
		{
			public int bounds;
			public int started;
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt__hheap_chunk
		{
			public stbtt__hheap_chunk* next;
		}

		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt__hheap
		{
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt__edge
		{
			public float x0;
			public float y0;
			public float x1;
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt__active_edge
		{
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbtt__point
		{
			public float x;
			public float y;
		}
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbrp_context
		{
			public int width;
			public int height;
			public int x;
		...
		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbrp_node
		{
			public byte x;
		}

		[StructLayout(LayoutKind.Sequential)]
		public unsafe partial struct stbrp_rect
		{
			public int x;
			public int y;
			public int id;
		...
		{
			if ((b->cursor) >= (b->size)) return (byte) (0);
		...
		public static stbtt__buf stbtt__buf_range(stbtt__buf* b, int o, int s)
		{
			...
			if (((((o) < (0)) || ((s) < (0))) || ((o) > (b->size))) || ((s) > (b->size - o))) return (stbtt__buf) (r);
			r.data = b->data + o;
			r.size = (int) (s);
			return (stbtt__buf) (r);
		}
		...
		public static uint stbtt__cff_int(stbtt__buf* b)
		{
			...
			else if ((b0) == (28)) return (uint) (stbtt__buf_get((b), (int) (2)));
			else if ((b0) == (29)) return (uint) (stbtt__buf_get((b), (int) (4)));
			return (uint) (0);
		}
		...
		public static stbtt__buf stbtt__dict_get(stbtt__buf* b, int key)
		{
			...
			while ((b->cursor) < (b->size))
			{
				...
				if ((op) == (12)) op = (int) (stbtt__buf_get8(b) | 0x100);
				if ((op) == (key)) return (stbtt__buf) (stbtt__buf_range(b, (int) (start), (int) (end - start)));
			}
		...
		{
			if ((stbtt__isfont(font_collection)) != 0) return (int) (1);
			if (((((((font_collection)[0]) == ("ttcf"[0])) && (((font_collection)[1]) == ("ttcf"[1]))) &&
			      (((font_collection)[2]) == ("ttcf"[2]))) && (((font_collection)[3]) == ("ttcf"[3]))))
			{
				if (((ttULONG(font_collection + 4)) == (0x00010000)) || ((ttULONG(font_collection + 4)) == (0x00020000)))
		...
		public static stbtt__buf stbtt__get_subrs(stbtt__buf cff, stbtt__buf fontdict)
		{
			...
			if ((private_loc[1] == 0) || (private_loc[0] == 0)) return (stbtt__buf) (stbtt__new_buf((null), (ulong) (0)));
			...
			if (subrsoff == 0) return (stbtt__buf) (stbtt__new_buf((null), (ulong) (0)));
		...
		public static int stbtt_InitFont_internal(stbtt_fontinfo* info, byte* data, int fontstart)
		{
			...
			if ((((cmap == 0) || (info->head == 0)) || (info->hhea == 0)) || (info->hmtx == 0)) return (int) (0);
			if ((info->glyf) != 0)
			{
				if (info->loca == 0) return (int) (0);
			}
			else
			{
				...
				if (cstype != 2) return (int) (0);
				if ((charstrings) == (0)) return (int) (0);
				if ((fdarrayoff) != 0)
				{
					if (fdselectoff == 0) return (int) (0);
			...
			if ((t) != 0) info->numGlyphs = (int) (ttUSHORT(data + t + 4));
		...
		public static int stbtt_FindGlyphIndex(stbtt_fontinfo* info, int unicode_codepoint)
		{
			...
			else if ((format) == (4))
			{
				...
				if ((unicode_codepoint) >= (ttUSHORT(data + search + rangeShift * 2))) search += (uint) (rangeShift * 2);
				search -= (uint) (2);
				...
				search += (uint) (2);
				{
					...
					return (int) (ttUSHORT(data + offset + (unicode_codepoint - start) * 2 + index_map + 14 + segcount * 6 + 2 +
					                       2 * item));
				}
			}
			else if (((format) == (12)) || ((format) == (13)))
			{
				...
				while ((low) < (high))
				{
					...
					else
					{
						...
						if ((format) == (12)) return (int) (start_glyph + unicode_codepoint - start_char);
		...
		public static int stbtt__close_shape(stbtt_vertex* vertices, int num_vertices, int was_off, int start_off, int sx,
			int sy, int scx, int scy, int cx, int cy)
		{
			if ((start_off) != 0)
			{
				if ((was_off) != 0)
					stbtt_setvertex(&vertices[num_vertices++], (byte) (STBTT_vcurve), (int) ((cx + scx) >> 1), (int) ((cy + scy) >> 1),
						(int) (cx), (int) (cy));
			...
			else
			{
				...
				else stbtt_setvertex(&vertices[num_vertices++], (byte) (STBTT_vline), (int) (sx), (int) (sy), (int) (0), (int) (0));
			}
			...
			*pvertices = (null);
			...
			if ((numberOfContours) > (0))
			{
				...
				for (i = (int) (0); (i) < (n); ++i)
				{
					...
					{
						if (i != 0)
							num_vertices = (int) (stbtt__close_shape(vertices, (int) (num_vertices), (int) (was_off), (int) (start_off),
					...
					else
					{
						...
						{
							if ((was_off) != 0)
								stbtt_setvertex(&vertices[num_vertices++], (byte) (STBTT_vcurve), (int) ((cx + x) >> 1), (int) ((cy + y) >> 1),
									(int) (cx), (int) (cy));
							cx = (int) (x);
							cy = (int) (y);
							was_off = (int) (1);
			...
			else if ((numberOfContours) == (-1))
			{
				...
				while ((more) != 0)
				{
					...
					if ((comp_num_verts) > (0))
					{
						...
						if ((num_vertices) > (0)) CRuntime.memcpy(tmp, vertices, (ulong) (num_vertices * sizeof(stbtt_vertex)));
		...
		{
			if (((x) > (c->max_x)) || (c->started == 0)) c->max_x = (int) (x);
			if (((y) > (c->max_y)) || (c->started == 0)) c->max_y = (int) (y);
			if (((x) < (c->min_x)) || (c->started == 0)) c->min_x = (int) (x);
			if (((y) < (c->min_y)) || (c->started == 0)) c->min_y = (int) (y);
			c->started = (int) (1);
		}
		...
		public static void stbtt__csctx_close_shape(stbtt__csctx* ctx)
		{
			if ((ctx->first_x != ctx->x) || (ctx->first_y != ctx->y))
				stbtt__csctx_v(ctx, (byte) (STBTT_vline), (int) (ctx->first_x), (int) (ctx->first_y), (int) (0), (int) (0),
					(int) (0), (int) (0));
		}
		...
		public static void stbtt__csctx_rccurve_to(stbtt__csctx* ctx, float dx1, float dy1, float dx2, float dy2, float dx3,
			float dy3)
		{
			...
			ctx->x = (float) (cx2 + dx3);
			ctx->y = (float) (cy2 + dy3);
			stbtt__csctx_v(ctx, (byte) (STBTT_vcubic), (int) (ctx->x), (int) (ctx->y), (int) (cx1), (int) (cy1), (int) (cx2),
				(int) (cy2));
		}
		...
		public static stbtt__buf stbtt__get_subr(stbtt__buf idx, int n)
		{
			...
			int bias = (int) (107);
			if ((count) >= (33900)) bias = (int) (32768);
			else if ((count) >= (1240)) bias = (int) (1131);
			n += (int) (bias);
			if (((n) < (0)) || ((n) >= (count))) return (stbtt__buf) (stbtt__new_buf((null), (ulong) (0)));
		...
		public static stbtt__buf stbtt__cid_get_glyph_subrs(stbtt_fontinfo* info, int glyph_index)
		{
			...
			if ((fdselector) == (-1)) stbtt__new_buf((null), (ulong) (0));
		...
		public static int stbtt__run_charstring(stbtt_fontinfo* info, int glyph_index, stbtt__csctx* c)
		{
			...
			while ((b.cursor) < (b.size))
			{
				...
				switch (b0)
				{
					case 0x13:
					case 0x14:
						if ((in_header) != 0) maskbits += (int) (sp / 2);
						in_header = (int) (0);
					...
					case 0x1E:
					{
						...
						for (;;)
						{
							...
							{
								if ((i + 3) >= (sp)) break;
								stbtt__csctx_rccurve_to(c, (float) (0), (float) (s[i]), (float) (s[i + 1]), (float) (s[i + 2]),
									(float) (s[i + 3]), (float) (((sp - i) == (5)) ? s[i + 4] : 0.0f));
								i += (int) (4);
							}
							else
							{
							...
							if ((i + 3) >= (sp)) break;
							stbtt__csctx_rccurve_to(c, (float) (s[i]), (float) (0), (float) (s[i + 1]), (float) (s[i + 2]),
								(float) (((sp - i) == (5)) ? s[i + 4] : 0.0f), (float) (s[i + 3]));
							i += (int) (4);
						}
					}
						break;
					...
					case 0x1B:
						...
						{
							if ((b0) == (0x1B))
								stbtt__csctx_rccurve_to(c, (float) (s[i]), (float) (f), (float) (s[i + 1]), (float) (s[i + 2]),
									(float) (s[i + 3]), (float) (0.0));
							else
								stbtt__csctx_rccurve_to(c, (float) (f), (float) (s[i]), (float) (s[i + 1]), (float) (s[i + 2]), (float) (0.0),
									(float) (s[i + 3]));
							f = (float) (0.0);
						}
					...
					case 0x1D:
						if ((b0) == (0x0A))
						{
							if (has_subrs == 0)
							{
								if ((info->fdselect.size) != 0) subrs = (stbtt__buf) (stbtt__cid_get_glyph_subrs(info, (int) (glyph_index)));
								has_subrs = (int) (1);
							}
						}
					...
					case 0x0C:
					{
						...
						switch (b1)
						{
							case 0x22:
								...
								dx5 = (float) (s[5]);
								dx6 = (float) (s[6]);
								stbtt__csctx_rccurve_to(c, (float) (dx1), (float) (0), (float) (dx2), (float) (dy2), (float) (dx3),
									(float) (0));
							...
							case 0x23:
								...
								dx6 = (float) (s[10]);
								dy6 = (float) (s[11]);
								stbtt__csctx_rccurve_to(c, (float) (dx1), (float) (dy1), (float) (dx2), (float) (dy2), (float) (dx3),
									(float) (dy3));
							...
							case 0x25:
								...
								if ((CRuntime.fabs((double) (dx))) > (CRuntime.fabs((double) (dy)))) dy6 = (float) (-dy);
								else dx6 = (float) (-dx);
								stbtt__csctx_rccurve_to(c, (float) (dx1), (float) (dy1), (float) (dx2), (float) (dy2), (float) (dx3),
									(float) (dy3));
								stbtt__csctx_rccurve_to(c, (float) (dx4), (float) (dy4), (float) (dx5), (float) (dy5), (float) (dx6),
					...
					default:
						...
						if ((b0) == (255))
						{
							f = (float) ((float) (stbtt__buf_get((&b), (int) (4))) / 0x10000);
						}
						else
						{
							stbtt__buf_skip(&b, (int) (-1));
						...
						if ((sp) >= (48)) return (int) (0);
						s[sp++] = (float) (f);
						clear_stack = (int) (0);
						break;
				}

				if ((clear_stack) != 0) sp = (int) (0);
			}
		...
		public static int stbtt__GetGlyphInfoT2(stbtt_fontinfo* info, int glyph_index, int* x0, int* y0, int* x1, int* y1)
		{
			...
			if ((x0) != null) *x0 = (int) ((r) != 0 ? c.min_x : 0);
			if ((y0) != null) *y0 = (int) ((r) != 0 ? c.min_y : 0);
			if ((x1) != null) *x1 = (int) ((r) != 0 ? c.max_x : 0);
			if ((y1) != null) *y1 = (int) ((r) != 0 ? c.max_y : 0);
		...
		{
			if (info->cff.size == 0) return (int) (stbtt__GetGlyphShapeTT(info, (int) (glyph_index), pvertices));
			else return (int) (stbtt__GetGlyphShapeT2(info, (int) (glyph_index), pvertices));
		}
			...
			int* leftSideBearing)
		{
			...
			{
				if ((advanceWidth) != null) *advanceWidth = (int) (ttSHORT(info->data + info->hmtx + 4 * glyph_index));
				if ((leftSideBearing) != null) *leftSideBearing = (int) (ttSHORT(info->data + info->hmtx + 4 * glyph_index + 2));
			}
			else
			{
		...
		public static int stbtt__GetGlyphKernInfoAdvance(stbtt_fontinfo* info, int glyph1, int glyph2)
		{
			...
			while (l <= r)
			{
				...
				if ((needle) < (straw)) r = (int) (m - 1);
				else if ((needle) > (straw)) l = (int) (m + 1);
				else return (int) (ttSHORT(data + 22 + (m * 6)));
			}
			...
			switch (coverageFormat)
			{
				...
				case 2:
				{
					...
					while (l <= r)
					{
						...
						if ((needle) < (strawStart)) r = (int) (m - 1);
						else if ((needle) > (strawEnd)) l = (int) (m + 1);
						else
						{
			...
			switch (classDefFormat)
			{
				...
				case 2:
				{
					...
					while (l <= r)
					{
						...
						else return (int) (ttUSHORT(classRangeRecord + 4));
					}
		...
		public static int stbtt__GetGlyphGPOSInfoAdvance(stbtt_fontinfo* info, int glyph1, int glyph2)
		{
			...
			byte* data;
			int i;
			if (info->gpos == 0) return (int) (0);
			data = info->data + info->gpos;
			if (ttUSHORT(data + 0) != 1) return (int) (0);
			if (ttUSHORT(data + 2) != 0) return (int) (0);
						...
						for (sti = (int) (0); (sti) < (subTableCount); sti++)
						{
							...
							switch (posFormat)
							{
								case 1:
								{
									...
									if (valueFormat1 != 4) return (int) (0);
									if (valueFormat2 != 0) return (int) (0);
									needle = (int) (glyph2);
		...
		{
			int xAdvance = (int) (0);
			if ((info->gpos) != 0) xAdvance += (int) (stbtt__GetGlyphGPOSInfoAdvance(info, (int) (g1), (int) (g2)));
			if ((info->kern) != 0) xAdvance += (int) (stbtt__GetGlyphKernInfoAdvance(info, (int) (g1), (int) (g2)));
			return (int) (xAdvance);
		}

		public static int stbtt_GetCodepointKernAdvance(stbtt_fontinfo* info, int ch1, int ch2)
		{
			if ((info->kern == 0) && (info->gpos == 0)) return (int) (0);
		...
		public static int stbtt_GetFontVMetricsOS2(stbtt_fontinfo* info, int* typoAscent, int* typoDescent, int* typoLineGap)
		{
			...
			if (tab == 0) return (int) (0);
			if ((typoAscent) != null) *typoAscent = (int) (ttSHORT(info->data + tab + 68));
			if ((typoDescent) != null) *typoDescent = (int) (ttSHORT(info->data + tab + 70));
			if ((typoLineGap) != null) *typoLineGap = (int) (ttSHORT(info->data + tab + 72));
			return (int) (1);
		}
			...
			float shift_x, float shift_y, int* ix0, int* iy0, int* ix1, int* iy1)
		{
			...
			{
				if ((ix0) != null) *ix0 = ((int) (CRuntime.floor((double) (x0 * scale_x + shift_x))));
				if ((iy0) != null) *iy0 = ((int) (CRuntime.floor((double) (-y1 * scale_y + shift_y))));
		...
		{
			stbtt_GetGlyphBitmapBoxSubpixel(font, (int) (stbtt_FindGlyphIndex(font, (int) (codepoint))), (float) (scale_x),
				(float) (scale_y), (float) (shift_x), (float) (shift_y), ix0, iy0, ix1, iy1);
		}

		public static void stbtt_GetCodepointBitmapBox(stbtt_fontinfo* font, int codepoint, float scale_x, float scale_y,
			int* ix0, int* iy0, int* ix1, int* iy1)
		{
			stbtt_GetCodepointBitmapBoxSubpixel(font, (int) (codepoint), (float) (scale_x), (float) (scale_y), (float) (0.0f),
				(float) (0.0f), ix0, iy0, ix1, iy1);
		}
			...
			else
			{
				if ((hh->num_remaining_in_head_chunk) == (0))
				{
					...
					stbtt__hheap_chunk* c =
						(stbtt__hheap_chunk*) (CRuntime.malloc((ulong) ((ulong) sizeof(stbtt__hheap_chunk) + size * (ulong) (count))));
			...
			while ((e) != null)
			{
				if ((e->fdx) == (0))
				{
					...
					if ((x0) < (len))
					{
						if ((x0) >= (0))
						{
							stbtt__handle_clipped_edge(scanline, (int) (x0), e, (float) (x0), (float) (y_top), (float) (x0),
								(float) (y_bottom));
							stbtt__handle_clipped_edge(scanline_fill - 1, (int) ((int) (x0) + 1), e, (float) (x0), (float) (y_top),
								(float) (x0), (float) (y_bottom));
						}
						else
						{
							stbtt__handle_clipped_edge(scanline_fill - 1, (int) (0), e, (float) (x0), (float) (y_top), (float) (x0),
								(float) (y_bottom));
						}
					}
				}
			...
			int off_x, int off_y, void* userdata)
		{
			...
			float* scanline;
			float* scanline2;
			if ((result->w) > (64)) scanline = (float*) (CRuntime.malloc((ulong) ((result->w * 2 + 1) * sizeof(float))));
		...
		public static void stbtt__rasterize(stbtt__bitmap* result, stbtt__point* pts, int* wcount, int windings,
			float scale_x, float scale_y, float shift_x, float shift_y, int off_x, int off_y, int invert, void* userdata)
		{
			...
			float y1, float x2, float y2, float x3, float y3, float objspace_flatness_squared, int n)
		{
			...
			if ((flatness_squared) > (objspace_flatness_squared))
			{
				...
				stbtt__tesselate_cubic(points, num_points, (float) (x0), (float) (y0), (float) (x01), (float) (y01), (float) (xa),
					(float) (ya), (float) (mx), (float) (my), (float) (objspace_flatness_squared), (int) (n + 1));
				stbtt__tesselate_cubic(points, num_points, (float) (mx), (float) (my), (float) (xb), (float) (yb), (float) (x23),
					(float) (y23), (float) (x3), (float) (y3), (float) (objspace_flatness_squared), (int) (n + 1));
			}
			else
			{
			...
			void* userdata)
		{
			...
			stbtt__point* windings = stbtt_FlattenCurves(vertices, (int) (num_verts), (float) (flatness_in_pixels / scale),
				&winding_lengths, &winding_count, userdata);
			if ((windings) != null)
			{
				stbtt__rasterize(result, windings, winding_lengths, (int) (winding_count), (float) (scale_x), (float) (scale_y),
					(float) (shift_x), (float) (shift_y), (int) (x_off), (int) (y_off), (int) (invert), userdata);
		...
		public static byte* stbtt_GetGlyphBitmapSubpixel(stbtt_fontinfo* info, float scale_x, float scale_y, float shift_x,
			float shift_y, int glyph, int* width, int* height, int* xoff, int* yoff)
		{
			int ix0;
			int iy0;
			int ix1;
			...
			stbtt_GetGlyphBitmapBoxSubpixel(info, (int) (glyph), (float) (scale_x), (float) (scale_y), (float) (shift_x),
				(float) (shift_y), &ix0, &iy0, &ix1, &iy1);
			gbm.w = (int) (ix1 - ix0);
			gbm.h = (int) (iy1 - iy0);
			gbm.pixels = (null);
			...
			if (((gbm.w) != 0) && ((gbm.h) != 0))
			{
				...
				if ((gbm.pixels) != null)
				{
					...
					stbtt_Rasterize(&gbm, (float) (0.35f), vertices, (int) (num_verts), (float) (scale_x), (float) (scale_y),
						(float) (shift_x), (float) (shift_y), (int) (ix0), (int) (iy0), (int) (1), info->userdata);
				}
			}
		...
		public static byte* stbtt_GetGlyphBitmap(stbtt_fontinfo* info, float scale_x, float scale_y, int glyph, int* width,
			int* height, int* xoff, int* yoff)
		{
			return stbtt_GetGlyphBitmapSubpixel(info, (float) (scale_x), (float) (scale_y), (float) (0.0f), (float) (0.0f),
				(int) (glyph), width, height, xoff, yoff);
		}
		...
		public static void stbtt_MakeGlyphBitmap(stbtt_fontinfo* info, byte* output, int out_w, int out_h, int out_stride,
			float scale_x, float scale_y, int glyph)
		{
			stbtt_MakeGlyphBitmapSubpixel(info, output, (int) (out_w), (int) (out_h), (int) (out_stride), (float) (scale_x),
				(float) (scale_y), (float) (0.0f), (float) (0.0f), (int) (glyph));
		}
		...
		{
			return stbtt_GetGlyphBitmapSubpixel(info, (float) (scale_x), (float) (scale_y), (float) (shift_x), (float) (shift_y),
				(int) (stbtt_FindGlyphIndex(info, (int) (codepoint))), width, height, xoff, yoff);
		}
		...
		{
			stbtt_MakeGlyphBitmapSubpixel(info, output, (int) (out_w), (int) (out_h), (int) (out_stride), (float) (scale_x),
				(float) (scale_y), (float) (shift_x), (float) (shift_y), (int) (stbtt_FindGlyphIndex(info, (int) (codepoint))));
		}

		public static byte* stbtt_GetCodepointBitmap(stbtt_fontinfo* info, float scale_x, float scale_y, int codepoint,
			int* width, int* height, int* xoff, int* yoff)
		{
			return stbtt_GetCodepointBitmapSubpixel(info, (float) (scale_x), (float) (scale_y), (float) (0.0f), (float) (0.0f),
				(int) (codepoint), width, height, xoff, yoff);
		}

		public static void stbtt_MakeCodepointBitmap(stbtt_fontinfo* info, byte* output, int out_w, int out_h, int out_stride,
			float scale_x, float scale_y, int codepoint)
		{
			stbtt_MakeCodepointBitmapSubpixel(info, output, (int) (out_w), (int) (out_h), (int) (out_stride), (float) (scale_x),
				(float) (scale_y), (float) (0.0f), (float) (0.0f), (int) (codepoint));
		}

		public static int stbtt_BakeFontBitmap_internal(byte* data, int offset, float pixel_height, byte* pixels, int pw,
			int ph, int first_char, int num_chars, stbtt_bakedchar* chardata)
		{
			float scale;
			int x;
			int y;
			...
			for (i = (int) (0); (i) < (num_chars); ++i)
			{
				...
				if ((y + gh + 1) >= (ph)) return (int) (-i);
				stbtt_MakeGlyphBitmap(&f, pixels + x + y * pw, (int) (gw), (int) (gh), (int) (pw), (float) (scale), (float) (scale),
					(int) (g));
				...
				x = (int) (x + gw + 1);
				if ((y + gh + 1) > (bottom_y)) bottom_y = (int) (y + gh + 1);
			}
		...
		public static void stbrp_pack_rects(stbrp_context* con, stbrp_rect* rects, int num_rects)
		{
			...
			for (i = (int) (0); (i) < (num_rects); ++i)
			{
				...
				con->x += (int) (rects[i].w);
				if ((con->y + rects[i].h) > (con->bottom_y)) con->bottom_y = (int) (con->y + rects[i].h);
			}
		...
		public static void stbtt_MakeGlyphBitmapSubpixelPrefilter(stbtt_fontinfo* info, byte* output, int out_w, int out_h,
			int out_stride, float scale_x, float scale_y, float shift_x, float shift_y, int prefilter_x, int prefilter_y,
			float* sub_x, float* sub_y, int glyph)
		{
			stbtt_MakeGlyphBitmapSubpixel(info, output, (int) (out_w - (prefilter_x - 1)), (int) (out_h - (prefilter_y - 1)),
				(int) (out_stride), (float) (scale_x), (float) (scale_y), (float) (shift_x), (float) (shift_y), (int) (glyph));
			if ((prefilter_x) > (1))
				...
				for (j = (int) (0); (j) < (ranges[i].num_chars); ++j)
				{
					...
					if ((r->was_packed) != 0)
					{
						...
						stbtt_MakeGlyphBitmapSubpixel(info, spc->pixels + r->x + r->y * spc->stride_in_bytes,
							...
							(float) (scale * spc->h_oversample), (float) (scale * spc->v_oversample), (float) (0), (float) (0),
							(int) (glyph));
						if ((spc->h_oversample) > (1))
							stbtt__h_prefilter(spc->pixels + r->x + r->y * spc->stride_in_bytes, (int) (r->w), (int) (r->h),
								(int) (spc->stride_in_bytes), (uint) (spc->h_oversample));
						if ((spc->v_oversample) > (1))
							stbtt__v_prefilter(spc->pixels + r->x + r->y * spc->stride_in_bytes, (int) (r->w), (int) (r->h),
								(int) (spc->stride_in_bytes), (uint) (spc->v_oversample));
			...
			for (i = (int) (0); (i) < (num_ranges); ++i)
			{
				for (j = (int) (0); (j) < (ranges[i].num_chars); ++j)
				{
					ranges[i].chardata_for_range[j].x0 = (ushort) (ranges[i].chardata_for_range[j].y0 =
						(ushort) (ranges[i].chardata_for_range[j].x1 = (ushort) (ranges[i].chardata_for_range[j].y1 = (ushort) (0))));
				}
			}
		...
		public static int stbtt__ray_intersect_bezier(float* orig, float* ray, float* q0, float* q1, float* q2, float* hits)
		{
			...
			if (a != 0.0)
			{
				...
				if ((discr) > (0.0))
				{
					...
					s0 = (float) ((b + d) * rcpna);
					s1 = (float) ((b - d) * rcpna);
					if (((s0) >= (0.0)) && (s0 <= 1.0)) num_s = (int) (1);
					if ((((d) > (0.0)) && ((s1) >= (0.0))) && (s1 <= 1.0))
					{
						if ((num_s) == (0)) s0 = (float) (s1);
						++num_s;
					}
				}
			}
		...
		public static int stbtt__compute_crossings_x(float x, float y, int nverts, stbtt_vertex* verts)
		{
			...
			if ((y_frac) < (0.01f)) y += (float) (0.01f);
			else if ((y_frac) > (0.99f)) y -= (float) (0.01f);
			orig[1] = (float) (y);
			for (i = (int) (0); (i) < (nverts); ++i)
			{
				if ((verts[i].type) == (STBTT_vline))
				{
					    ...
					    ((x) > ((x0) < (x1) ? (x0) : (x1))))
					{
						...
						if ((x_inter) < (x)) winding += (int) (((y0) < (y1)) ? 1 : -1);
					}
				}
		...
		{
			if ((x) < (0)) return (float) (-(float) (CRuntime.pow((double) (-x), (double) (1.0f / 3.0f))));
			else return (float) (CRuntime.pow((double) (x), (double) (1.0f / 3.0f)));
		}
			...
			scale_y = (float) (-scale_y);
			{
				...
				for (i = (int) (0), j = (int) (num_verts - 1); (i) < (num_verts); j = (int) (i++))
				{
					...
					else if ((verts[i].type) == (STBTT_vcurve))
					{
						...
						if (len2 != 0.0f) precompute[i] = (float) (1.0f / (bx * bx + by * by));
						else precompute[i] = (float) (0.0f);
					}
					else precompute[i] = (float) (0.0f);
				}
				...
				for (y = (int) (iy0); (y) < (iy1); ++y)
				{
					for (x = (int) (ix0); (x) < (ix1); ++x)
					{
						...
						int winding =
							(int) (stbtt__compute_crossings_x((float) (x_gspace), (float) (y_gspace), (int) (num_verts), verts));
						for (i = (int) (0); (i) < (num_verts); ++i)
						{
							float x0 = (float) (verts[i].x * scale_x);
							float y0 = (float) (verts[i].y * scale_y);
							float dist2 = (float) ((x0 - sx) * (x0 - sx) + (y0 - sy) * (y0 - sy));
							if ((dist2) < (min_dist * min_dist)) min_dist = ((float) (CRuntime.sqrt((double) (dist2))));
							if ((verts[i].type) == (STBTT_vline))
							{
								float x1 = (float) (verts[i - 1].x * scale_x);
								float y1 = (float) (verts[i - 1].y * scale_y);
								float dist = (float) ((float) (CRuntime.fabs((double) ((x1 - x0) * (y0 - sy) - (y1 - y0) * (x0 - sx)))) *
								                      precompute[i]);
								if ((dist) < (min_dist))
								{
									...
									if (((t) >= (0.0f)) && (t <= 1.0f)) min_dist = (float) (dist);
								}
							}
							else if ((verts[i].type) == (STBTT_vcurve))
							{
						...
						if ((winding) == (0)) min_dist = (float) (-min_dist);
						val = (float) (onedge_value + pixel_dist_scale * min_dist);
						if ((val) < (0)) val = (float) (0);
						else if ((val) > (255)) val = (float) (255);
		...
		public static int stbtt__CompareUTF8toUTF16_bigendian_prefix(byte* s1, int len1, byte* s2, int len2)
		{
			...
			while ((len2) != 0)
			{
				...
				if ((ch) < (0x80))
				{
					if ((i) >= (len1)) return (int) (-1);
					if (s1[i++] != ch) return (int) (-1);
				}
				else if ((ch) < (0x800))
				{
					if ((i + 1) >= (len1)) return (int) (-1);
					if (s1[i++] != 0xc0 + (ch >> 6)) return (int) (-1);
					if (s1[i++] != 0x80 + (ch & 0x3f)) return (int) (-1);
				}
				else if (((ch) >= (0xd800)) && ((ch) < (0xdc00)))
				{
					uint c;
					ushort ch2 = (ushort) (s2[2] * 256 + s2[3]);
					if ((i + 3) >= (len1)) return (int) (-1);
					c = (uint) (((ch - 0xd800) << 10) + (ch2 - 0xdc00) + 0x10000);
					if (s1[i++] != 0xf0 + (c >> 18)) return (int) (-1);
					if (s1[i++] != 0x80 + ((c >> 12) & 0x3f)) return (int) (-1);
					if (s1[i++] != 0x80 + ((c >> 6) & 0x3f)) return (int) (-1);
					if (s1[i++] != 0x80 + ((c) & 0x3f)) return (int) (-1);
					s2 += 2;
					len2 -= (int) (2);
				}
				...
				{
					if ((i + 2) >= (len1)) return (int) (-1);
					if (s1[i++] != 0xe0 + (ch >> 12)) return (int) (-1);
					if (s1[i++] != 0x80 + ((ch >> 6) & 0x3f)) return (int) (-1);
					if (s1[i++] != 0x80 + ((ch) & 0x3f)) return (int) (-1);
				}
		...
		{
			return (int) ((len1) == (stbtt__CompareUTF8toUTF16_bigendian_prefix((byte*) (s1), (int) (len1), (byte*) (s2),
				              (int) (len2)))
				? 1
				: 0);
		}
			...
			for (i = (int) (0); (i) < (count); ++i)
			{
				...
				if ((id) == (target_id))
				{
					    ...
					    (((platform) == (3)) && ((encoding) == (10))))
					{
						...
						int matchlen =
							(int) (stbtt__CompareUTF8toUTF16_bigendian_prefix(name, (int) (nlen), fc + stringOffset + off, (int) (slen)));
						if ((matchlen) >= (0))
						{
							    ...
							    ((ttUSHORT(fc + loc + 12 + 4)) == (language)))
							{
								...
								{
									++matchlen;
									if ((stbtt_CompareUTF8toUTF16_bigendian_internal((sbyte*) (name + matchlen), (int) (nlen - matchlen),
										    (sbyte*) (fc + stringOffset + off), (int) (slen))) != 0) return (int) (1);
								}
							}
							else
							{
		...
		public static int stbtt__matches(byte* fc, uint offset, byte* name, int flags)
		{
			...
			if ((flags) != 0)
			{
				...
				if ((ttUSHORT(fc + hd + 44) & 7) != (flags & 7)) return (int) (0);
			}
			...
			if ((flags) != 0)
			{
				if ((stbtt__matchpair(fc, (uint) (nm), name, (int) (nlen), (int) (16), (int) (-1))) != 0) return (int) (1);
				if ((stbtt__matchpair(fc, (uint) (nm), name, (int) (nlen), (int) (1), (int) (-1))) != 0) return (int) (1);
				if ((stbtt__matchpair(fc, (uint) (nm), name, (int) (nlen), (int) (3), (int) (-1))) != 0) return (int) (1);
			}
			else
			{
				if ((stbtt__matchpair(fc, (uint) (nm), name, (int) (nlen), (int) (16), (int) (17))) != 0) return (int) (1);
				if ((stbtt__matchpair(fc, (uint) (nm), name, (int) (nlen), (int) (1), (int) (2))) != 0) return (int) (1);
				if ((stbtt__matchpair(fc, (uint) (nm), name, (int) (nlen), (int) (3), (int) (-1))) != 0) return (int) (1);
			}
		...
		public static int stbtt_FindMatchingFont_internal(byte* font_collection, sbyte* name_utf8, int flags)
		{
			...
			for (i = (int) (0);; ++i)
			{
				...
				if ((stbtt__matches(font_collection, (uint) (off), (byte*) (name_utf8), (int) (flags))) != 0) return (int) (off);
			}
		}
		...
		{
			return (int) (stbtt_BakeFontBitmap_internal(data, (int) (offset), (float) (pixel_height), pixels, (int) (pw),
				(int) (ph), (int) (first_char), (int) (num_chars), chardata));
		}
