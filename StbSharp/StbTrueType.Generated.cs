// Generated by Sichem at 1/23/2018 7:40:31 PM
...
namespace StbSharp
{
	unsafe partial class StbTrueType
	{
		...
		{
			public stbtt__hheap_chunk* _next_;
		}
		...
		{
			public stbtt__active_edge* _next_;
			public float fx;
			public float fdx;
			public float fdy;
		...
		public const int STBTT_MS_LANG_ENGLISH = 0;
		public const int STBTT_MS_LANG_ITALIAN = 0;
		public const int STBTT_MS_LANG_CHINESE = 0;
		public const int STBTT_MS_LANG_JAPANESE = 0;
		public const int STBTT_MS_LANG_DUTCH = 0;
		public const int STBTT_MS_LANG_KOREAN = 0;
		public const int STBTT_MS_LANG_FRENCH = 0;
		public const int STBTT_MS_LANG_RUSSIAN = 0;
		public const int STBTT_MS_LANG_GERMAN = 0;
		public const int STBTT_MS_LANG_SPANISH = 0;
		public const int STBTT_MS_LANG_HEBREW = 0;
		public const int STBTT_MS_LANG_SWEDISH = 0;
		...
		public static uint stbtt__buf_get(stbtt__buf* b, int n)
		{
			uint v = (uint)(0);
			int i;
			for (i = (int)(0); (i) < (n); i++) {v = (uint)((v << 8) | stbtt__buf_get8(b));}
			return (uint)(v);
		}
		...
		{
			int count;int start;int offsize;
			start = (int)(b->cursor);
			count = (int)(stbtt__buf_get((b), (int)(2)));
			if ((count) != 0) {
offsize = (int)(stbtt__buf_get8(b));stbtt__buf_skip(b, (int)(offsize * count));stbtt__buf_skip(b, (int)(stbtt__buf_get(b, (int)(offsize)) - 1));}
		...
		public static uint stbtt__cff_int(stbtt__buf* b)
		{
			...
			if (((b0) >= (32)) && (b0 <= 246)) return (uint)(b0 - 139); else if (((b0) >= (247)) && (b0 <= 250)) return (uint)((b0 - 247) * 256 + stbtt__buf_get8(b) + 108); else if (((b0) >= (251)) && (b0 <= 254)) return (uint)(-(b0 - 251) * 256 - stbtt__buf_get8(b) - 108); else if ((b0) == (28)) return (uint)(stbtt__buf_get((b), (int)(2))); else if ((b0) == (29)) return (uint)(stbtt__buf_get((b), (int)(4)));
			return (uint)(0);
		}

		public static void stbtt__cff_skip_operand(stbtt__buf* b)
		{
			int v;int b0 = (int)(stbtt__buf_peek8(b));
			if ((b0) == (30)) {
stbtt__buf_skip(b, (int)(1));while ((b->cursor) < (b->size)) {
v = (int)(stbtt__buf_get8(b));if (((v & 0xF) == (0xF)) || ((v >> 4) == (0xF))) break;}}
 else {
stbtt__cff_int(b);}
...
int start = (int)(b->cursor);int end;int op;while ((stbtt__buf_peek8(b)) >= (28)) {stbtt__cff_skip_operand(b);}end = (int)(b->cursor);op = (int)(stbtt__buf_get8(b));if ((op) == (12)) op = (int)(stbtt__buf_get8(b) | 0x100);if ((op) == (key)) return (stbtt__buf)(stbtt__buf_range(b, (int)(start), (int)(end - start)));}
		...
		public static void stbtt__dict_get_ints(stbtt__buf* b, int key, int outcount, uint* _out_)
		{
			...
			for (i = (int)(0); ((i) < (outcount)) && ((operands.cursor) < (operands.size)); i++) {_out_[i] = (uint)(stbtt__cff_int(&operands));}
		}
		...
		{
			int count;int offsize;int start;int end;
			stbtt__buf_seek(&b, (int)(0));
			count = (int)(stbtt__buf_get((&b), (int)(2)));
		...
		public static int stbtt__isfont(byte* font)
		{
			...
			if (((((((font)[0]) == ("true"[0])) && (((font)[1]) == ("true"[1]))) && (((font)[2]) == ("true"[2]))) && (((font)[3]) == ("true"[3])))) return (int)(1);
			return (int)(0);
		}
...
return (int)(ttLONG(font_collection + 8));}
		...
		{
			uint subrsoff = (uint)(0);uint* private_loc = stackalloc uint[2];
...
ushort end;searchRange >>= 1;end = (ushort)(ttUSHORT(data + search + searchRange * 2));if ((unicode_codepoint) > (end)) search += (uint)(searchRange * 2);--entrySelector;}search += (uint)(2);{
ushort offset;ushort start;ushort item = (ushort)((search - endCount) >> 1);start = (ushort)(ttUSHORT(data + index_map + 14 + segcount * 2 + 2 + 2 * item));if ((unicode_codepoint) < (start)) return (int)(0);offset = (ushort)(ttUSHORT(data + index_map + 14 + segcount * 6 + 2 + 2 * item));if ((offset) == (0)) return (int)((ushort)(unicode_codepoint + ttSHORT(data + index_map + 14 + segcount * 4 + 2 + 2 * item)));return (int)(ttUSHORT(data + offset + (unicode_codepoint - start) * 2 + index_map + 14 + segcount * 6 + 2 + 2 * item));}
}
 else if (((format) == (12)) || ((format) == (13))) {
uint ngroups = (uint)(ttULONG(data + index_map + 12));int low;int high;low = (int)(0);high = ((int)(ngroups));while ((low) < (high)) {
...
int g = (int)(stbtt__GetGlyfOffset(info, (int)(glyph_index)));if ((g) < (0)) return (int)(0);if ((x0) != null) *x0 = (int)(ttSHORT(info->data + g + 2));if ((y0) != null) *y0 = (int)(ttSHORT(info->data + g + 4));if ((x1) != null) *x1 = (int)(ttSHORT(info->data + g + 6));if ((y1) != null) *y1 = (int)(ttSHORT(info->data + g + 8));}
		...
		public static int stbtt_IsGlyphEmpty(stbtt_fontinfo* info, int glyph_index)
		{
			...
			int g;
			if ((info->cff.size) != 0) return (int)((stbtt__GetGlyphInfoT2(info, (int)(glyph_index), (null), (null), (null), (null))) == (0)?1:0);
...
byte flags = (byte)(0);byte flagcount;int ins;int i;int j = (int)(0);int m;int n;int next_move;int was_off = (int)(0);int off;int start_off = (int)(0);int x;int y;int cx;int cy;int sx;int sy;int scx;int scy;byte* points;endPtsOfContours = (data + g + 10);ins = (int)(ttUSHORT(data + g + 10 + numberOfContours * 2));points = data + g + 10 + numberOfContours * 2 + 2 + ins;n = (int)(1 + ttUSHORT(endPtsOfContours + numberOfContours * 2 - 2));m = (int)(n + 2 * numberOfContours);vertices = (stbtt_vertex*)(CRuntime.malloc((ulong)(m * sizeof(stbtt_vertex))));if (vertices == null) return (int)(0);next_move = (int)(0);flagcount = (byte)(0);off = (int)(m - n);for (i = (int)(0); (i) < (n); ++i) {
if ((flagcount) == (0)) {
...
if (i != 0) num_vertices = (int)(stbtt__close_shape(vertices, (int)(num_vertices), (int)(was_off), (int)(start_off), (int)(sx), (int)(sy), (int)(scx), (int)(scy), (int)(cx), (int)(cy)));start_off = ((flags & 1) != 0?1:0);if ((start_off) != 0) {
...
ushort flags;ushort gidx;int comp_num_verts = (int)(0);int i;stbtt_vertex* comp_verts = null;stbtt_vertex* tmp = null;float* mtx = stackalloc float[6];
mtx[0] = (float)(1);
mtx[1] = (float)(0);
mtx[2] = (float)(0);
mtx[3] = (float)(1);
mtx[4] = (float)(0);
mtx[5] = (float)(0);
float m;float n;flags = (ushort)(ttSHORT(comp));comp += 2;gidx = (ushort)(ttSHORT(comp));comp += 2;if ((flags & 2) != 0) {
if ((flags & 1) != 0) {
...
stbtt_vertex* v = &comp_verts[i];short x;short y;x = (short)(v->x);y = (short)(v->y);v->x = ((short)(m * (mtx[0] * x + mtx[2] * y + mtx[4])));v->y = ((short)(n * (mtx[1] * x + mtx[3] * y + mtx[5])));x = (short)(v->cx);y = (short)(v->cy);v->cx = ((short)(m * (mtx[0] * x + mtx[2] * y + mtx[4])));v->cy = ((short)(n * (mtx[1] * x + mtx[3] * y + mtx[5])));}tmp = (stbtt_vertex*)(CRuntime.malloc((ulong)((num_vertices + comp_num_verts) * sizeof(stbtt_vertex))));if (tmp== null) {
if ((vertices) != null) CRuntime.free(vertices);if ((comp_verts) != null) CRuntime.free(comp_verts);return (int)(0);}
if ((num_vertices) > (0)) CRuntime.memcpy(tmp, vertices, (ulong)(num_vertices * sizeof(stbtt_vertex)));CRuntime.memcpy(tmp + num_vertices, comp_verts, (ulong)(comp_num_verts * sizeof(stbtt_vertex)));if ((vertices) != null) CRuntime.free(vertices);vertices = tmp;CRuntime.free(comp_verts);num_vertices += (int)(comp_num_verts);}
more = (int)(flags & (1 << 5));}}
		...
		{
			if ((c->bounds) != 0) {
stbtt__track_vertex(c, (int)(x), (int)(y));if ((type) == (STBTT_vcubic)) {
stbtt__track_vertex(c, (int)(cx), (int)(cy));stbtt__track_vertex(c, (int)(cx1), (int)(cy1));}
}
 else {
stbtt_setvertex(&c->pvertices[c->num_vertices], (byte)(type), (int)(x), (int)(y), (int)(cx), (int)(cy));c->pvertices[c->num_vertices].cx1 = ((short)(cx1));c->pvertices[c->num_vertices].cy1 = ((short)(cy1));}
		...
		{
			if ((ctx->first_x != ctx->x) || (ctx->first_y != ctx->y)) stbtt__csctx_v(ctx, (byte)(STBTT_vline), (int)(ctx->first_x), (int)(ctx->first_y), (int)(0), (int)(0), (int)(0), (int)(0));
		}
		...
		public static stbtt__buf stbtt__get_subr(stbtt__buf idx, int n)
		{
			...
			int bias = (int)(107);
			if ((count) >= (33900)) bias = (int)(32768); else if ((count) >= (1240)) bias = (int)(1131);
			n += (int)(bias);
		...
		public static stbtt__buf stbtt__cid_get_glyph_subrs(stbtt_fontinfo* info, int glyph_index)
		{
			...
			int nranges;int start;int end;int v;int fmt;int fdselector = (int)(-1);int i;
			stbtt__buf_seek(&fdselect, (int)(0));
			fmt = (int)(stbtt__buf_get8(&fdselect));
			if ((fmt) == (0)) {
stbtt__buf_skip(&fdselect, (int)(glyph_index));fdselector = (int)(stbtt__buf_get8(&fdselect));}
 else if ((fmt) == (3)) {
nranges = (int)(stbtt__buf_get((&fdselect), (int)(2)));start = (int)(stbtt__buf_get((&fdselect), (int)(2)));for (i = (int)(0); (i) < (nranges); i++) {
v = (int)(stbtt__buf_get8(&fdselect));end = (int)(stbtt__buf_get((&fdselect), (int)(2)));if (((glyph_index) >= (start)) && ((glyph_index) < (end))) {
fdselector = (int)(v);break;}
start = (int)(end);}}
...
*pvertices = (stbtt_vertex*)(CRuntime.malloc((ulong)(count_ctx.num_vertices * sizeof(stbtt_vertex))));output_ctx.pvertices = *pvertices;if ((stbtt__run_charstring(info, (int)(glyph_index), &output_ctx)) != 0) {
return (int)(output_ctx.num_vertices);}
		...
		public static int stbtt__GetGlyphInfoT2(stbtt_fontinfo* info, int glyph_index, int* x0, int* y0, int* x1, int* y1)
		{
			...
			if ((x0) != null) {
*x0 = (int)((r) != 0?c.min_x:0);*y0 = (int)((r) != 0?c.min_y:0);*x1 = (int)((r) != 0?c.max_x:0);*y1 = (int)((r) != 0?c.max_y:0);}
		...
		{
			if (info->cff.size== 0) return (int)(stbtt__GetGlyphShapeTT(info, (int)(glyph_index), pvertices)); else return (int)(stbtt__GetGlyphShapeT2(info, (int)(glyph_index), pvertices));
		}
...
m = (int)((l + r) >> 1);straw = (uint)(ttULONG(data + 18 + (m * 6)));if ((needle) < (straw)) r = (int)(m - 1); else if ((needle) > (straw)) l = (int)(m + 1); else return (int)(ttSHORT(data + 22 + (m * 6)));}
		...
		{
			int x0 = (int)(0);int y0 = (int)(0);int x1;int y1;
...
int count = (int)((size) < (32)?2000:(size) < (128)?800:100);stbtt__hheap_chunk* c = (stbtt__hheap_chunk*)(CRuntime.malloc((ulong)((ulong)sizeof(stbtt__hheap_chunk)+ size * (ulong)(count))));if ((c) == (null)) return (null);c->_next_ = hh->head;hh->head = c;hh->num_remaining_in_head_chunk = (int)(count);}
--hh->num_remaining_in_head_chunk;return (sbyte*)(hh->head) + size * (ulong)(hh->num_remaining_in_head_chunk);}
		...
		public static void stbtt__hheap_cleanup(stbtt__hheap* hh, void * userdata)
		{
			...
			while ((c) != null) {
stbtt__hheap_chunk* n = c->_next_;CRuntime.free(c);c = n;}
		}
...
x1 += (float)((x1 - x0) * (e->ey - y1) / (y1 - y0));y1 = (float)(e->ey);}
			...
			if ((x0 <= x) && (x1 <= x)) scanline[x] += (float)(e->direction * (y1 - y0)); else if (((x0) >= (x + 1)) && ((x1) >= (x + 1))) {
}
 else {
...
float x0 = (float)(e->fx);float dx = (float)(e->fdx);float xb = (float)(x0 + dx);float x_top;float x_bottom;float sy0;float sy1;float dy = (float)(e->fdy);if ((e->sy) > (y_top)) {
...
float height;int x = (int)(x_top);height = (float)(sy1 - sy0);scanline[x] += (float)(e->direction * (1 - ((x_top - x) + (x_bottom - x)) / 2) * height);scanline_fill[x] += (float)(e->direction * height);}
 else {
int x;int x1;int x2;float y_crossing;float step;float sign;float area;if ((x_top) > (x_bottom)) {
float t;sy0 = (float)(y_bottom - (sy0 - y_top));sy1 = (float)(y_bottom - (sy1 - y_top));t = (float)(sy0);sy0 = (float)(sy1);sy1 = (float)(t);t = (float)(x_bottom);x_bottom = (float)(x_top);x_top = (float)(t);dx = (float)(-dx);dy = (float)(-dy);t = (float)(x0);x0 = (float)(xb);xb = (float)(t);}
...
scanline[x] += (float)(area + step / 2);area += (float)(step);}y_crossing += (float)(dy * (x2 - (x1 + 1)));scanline[x2] += (float)(area + sign * (1 - ((x2 - x2) + (x_bottom - x2)) / 2) * (sy1 - y_crossing));scanline_fill[x2] += (float)(sign * (sy1 - sy0));}
}
 else {
int x;for (x = (int)(0); (x) < (len); ++x) {
float y0 = (float)(y_top);float x1 = (float)(x);float x2 = (float)(x + 1);float x3 = (float)(xb);float y3 = (float)(y_bottom);float y1 = (float)((x - x0) / dx + y_top);float y2 = (float)((x + 1 - x0) / dx + y_top);if (((x0) < (x1)) && ((x3) > (x2))) {
...
e = e->_next_;}
		...
		public static void stbtt__rasterize_sorted_edges(stbtt__bitmap* result, stbtt__edge* e, int n, int vsubsample, int off_x, int off_y, void * userdata)
		{
			...
			if ((result->w) > (64)) scanline = (float*)(CRuntime.malloc((ulong)((result->w * 2 + 1) * sizeof(float)))); else scanline = scanline_data;
			scanline2 = scanline + result->w;
			y = (int)(off_y);
			e[n].y0 = (float)((float)(off_y + result->h) + 1);
			while ((j) < (result->h)) {
float scan_y_top = (float)(y + 0.0f);float scan_y_bottom = (float)(y + 1.0f);stbtt__active_edge** step = &active;CRuntime.memset(scanline, (int)(0), (ulong)(result->w * sizeof(float)));CRuntime.memset(scanline2, (int)(0), (ulong)((result->w + 1) * sizeof(float)));while ((*step) != null) {
stbtt__active_edge* z = *step;if (z->ey <= scan_y_top) {
*step = z->_next_;z->direction = (float)(0);stbtt__hheap_free(&hh, z);}
 else {
step = &((*step)->_next_);}
}while (e->y0 <= scan_y_bottom) {
if (e->y0 != e->y1) {
stbtt__active_edge* z = stbtt__new_active(&hh, e, (int)(off_x), (float)(scan_y_top), userdata);if (z != (null)) {
z->_next_ = active;active = z;}
}
...
float k;int m;sum += (float)(scanline2[i]);k = (float)(scanline[i] + sum);k = (float)((float)(CRuntime.fabs((double)(k))) * 255 + 0.5f);m = ((int)(k));if ((m) > (255)) m = (int)(255);result->pixels[j * result->stride + i] = ((byte)(m));}}
step = &active;while ((*step) != null) {
stbtt__active_edge* z = *step;z->fx += (float)(z->fdx);step = &((*step)->_next_);}++y;++j;}
...
stbtt__edge* b = &p[j - 1];int c = (int)(a->y0 < b->y0?1:0);if (c== 0) break;p[j] = (stbtt__edge)(p[j - 1]);--j;}if (i != j) p[j] = (stbtt__edge)(t);}
		}

		public static void stbtt__sort_edges_quicksort(stbtt__edge* p, int n)
		{
			while ((n) > (12)) {
stbtt__edge t =  new stbtt__edge();int c01;int c12;int c;int m;int i;int j;m = (int)(n >> 1);c01 = (int)(((&p[0])->y0) < ((&p[m])->y0)?1:0);c12 = (int)(((&p[m])->y0) < ((&p[n - 1])->y0)?1:0);if (c01 != c12) {
int z;c = (int)(((&p[0])->y0) < ((&p[n - 1])->y0)?1:0);z = (int)(((c) == (c12))?0:n - 1);t = (stbtt__edge)(p[z]);p[z] = (stbtt__edge)(p[m]);p[m] = (stbtt__edge)(t);}
t = (stbtt__edge)(p[0]);p[0] = (stbtt__edge)(p[m]);p[m] = (stbtt__edge)(t);i = (int)(1);j = (int)(n - 1);for (; ; ) {
for (i = (int)(i); ; ++i) {
if (!(((&p[i])->y0) < ((&p[0])->y0))) break;}for (j = (int)(j); ; --j) {
if (!(((&p[0])->y0) < ((&p[j])->y0))) break;}if ((i) >= (j)) break;t = (stbtt__edge)(p[i]);p[i] = (stbtt__edge)(p[j]);p[j] = (stbtt__edge)(t);++i;--j;}if ((j) < (n - i)) {
...
int a = (int)(k);int b = (int)(j);if ((p[j].y) == (p[k].y)) ;e[n].invert = (int)(0);if ((((invert) != 0) && ((p[j].y) > (p[k].y))) || ((invert== 0) && ((p[j].y) < (p[k].y)))) {
...
float x01 = (float)((x0 + x1) / 2);float y01 = (float)((y0 + y1) / 2);float x12 = (float)((x1 + x2) / 2);float y12 = (float)((y1 + y2) / 2);float x23 = (float)((x2 + x3) / 2);float y23 = (float)((y2 + y3) / 2);float xa = (float)((x01 + x12) / 2);float ya = (float)((y01 + y12) / 2);float xb = (float)((x12 + x23) / 2);float yb = (float)((y12 + y23) / 2);float mx = (float)((xa + xb) / 2);float my = (float)((ya + yb) / 2);stbtt__tesselate_cubic(points, num_points, (float)(x0), (float)(y0), (float)(x01), (float)(y01), (float)(xa), (float)(ya), (float)(mx), (float)(my), (float)(objspace_flatness_squared), (int)(n + 1));stbtt__tesselate_cubic(points, num_points, (float)(mx), (float)(my), (float)(xb), (float)(yb), (float)(x23), (float)(y23), (float)(x3), (float)(y3), (float)(objspace_flatness_squared), (int)(n + 1));}
 else {
stbtt__add_point(points, (int)(*num_points), (float)(x3), (float)(y3));*num_points = (int)(*num_points + 1);}
		...
		public static stbtt__point* stbtt_FlattenCurves(stbtt_vertex* vertices, int num_verts, float objspace_flatness, int** contour_lengths, int* num_contours, void * userdata)
		{
			...
			int i;int n = (int)(0);int start = (int)(0);int pass;
...
points = (stbtt__point*)(CRuntime.malloc((ulong)(num_points * sizeof(stbtt__point))));if ((points) == (null)) goto error;}
num_points = (int)(0);n = (int)(-1);for (i = (int)(0); (i) < (num_verts); ++i) {
switch (vertices[i].type){
case STBTT_vmove:if ((n) >= (0)) (*contour_lengths)[n] = (int)(num_points - start);++n;start = (int)(num_points);x = (float)(vertices[i].x);y = (float)(vertices[i].y);stbtt__add_point(points, (int)(num_points++), (float)(x), (float)(y));break;case STBTT_vline:x = (float)(vertices[i].x);y = (float)(vertices[i].y);stbtt__add_point(points, (int)(num_points++), (float)(x), (float)(y));break;case STBTT_vcurve:stbtt__tesselate_curve(points, &num_points, (float)(x), (float)(y), (float)(vertices[i].cx), (float)(vertices[i].cy), (float)(vertices[i].x), (float)(vertices[i].y), (float)(objspace_flatness_squared), (int)(0));x = (float)(vertices[i].x);y = (float)(vertices[i].y);break;case STBTT_vcubic:stbtt__tesselate_cubic(points, &num_points, (float)(x), (float)(y), (float)(vertices[i].cx), (float)(vertices[i].cy), (float)(vertices[i].cx1), (float)(vertices[i].cy1), (float)(vertices[i].x), (float)(vertices[i].y), (float)(objspace_flatness_squared), (int)(0));x = (float)(vertices[i].x);y = (float)(vertices[i].y);break;}
...
CRuntime.free(points);
		...
		public static void stbtt_Rasterize(stbtt__bitmap* result, float flatness_in_pixels, stbtt_vertex* vertices, int num_verts, float scale_x, float scale_y, float shift_x, float shift_y, int x_off, int y_off, int invert, void * userdata)
		{
			...
			if ((windings) != null) {
stbtt__rasterize(result, windings, winding_lengths, (int)(winding_count), (float)(scale_x), (float)(scale_y), (float)(shift_x), (float)(shift_y), (int)(x_off), (int)(y_off), (int)(invert), userdata);CRuntime.free(winding_lengths);CRuntime.free(windings);}
		...
		public static byte* stbtt_GetGlyphBitmapSubpixel(stbtt_fontinfo* info, float scale_x, float scale_y, float shift_x, float shift_y, int glyph, int* width, int* height, int* xoff, int* yoff)
		{
			...
			if ((scale_y) == (0)) {
if ((scale_x) == (0)) {
CRuntime.free(vertices);return (null);}
scale_y = (float)(scale_x);}
			...
			if (((gbm.w) != 0) && ((gbm.h) != 0)) {
gbm.pixels = (byte*)(CRuntime.malloc((ulong)(gbm.w * gbm.h)));if ((gbm.pixels) != null) {
gbm.stride = (int)(gbm.w);stbtt_Rasterize(&gbm, (float)(0.35f), vertices, (int)(num_verts), (float)(scale_x), (float)(scale_y), (float)(shift_x), (float)(shift_y), (int)(ix0), (int)(iy0), (int)(1), info->userdata);}
		...
		{
			float scale;
			int x;int y;int bottom_y;int i;
...
int advance;int lsb;int x0;int y0;int x1;int y1;int gw;int gh;int g = (int)(stbtt_FindGlyphIndex(&f, (int)(first_char + i)));stbtt_GetGlyphHMetrics(&f, (int)(g), &advance, &lsb);stbtt_GetGlyphBitmapBox(&f, (int)(g), (float)(scale), (float)(scale), &x0, &y0, &x1, &y1);gw = (int)(x1 - x0);gh = (int)(y1 - y0);if ((x + gw + 1) >= (pw)) {
y = (int)(bottom_y);x = (int)(1);}
if ((y + gh + 1) >= (ph)) return (int)(-i);stbtt_MakeGlyphBitmap(&f, pixels + x + y * pw, (int)(gw), (int)(gh), (int)(pw), (float)(scale), (float)(scale), (int)(g));chardata[i].x0 = (ushort)((short)(x));chardata[i].y0 = (ushort)((short)(y));chardata[i].x1 = (ushort)((short)(x + gw));chardata[i].y1 = (ushort)((short)(y + gh));chardata[i].xadvance = (float)(scale * advance);chardata[i].xoff = ((float)(x0));chardata[i].yoff = ((float)(y0));x = (int)(x + gw + 1);if ((y + gh + 1) > (bottom_y)) bottom_y = (int)(y + gh + 1);}
			return (int)(bottom_y);
		}
...
if (context != (null)) CRuntime.free(context);if (nodes != (null)) CRuntime.free(nodes);return (int)(0);}
		...
		public static void stbtt__h_prefilter(byte* pixels, int w, int h, int stride_in_bytes, uint kernel_width)
		{
			...
			for (j = (int)(0); (j) < (h); ++j) {
int i;uint total;CRuntime.memset(buffer, (int)(0), (ulong)(kernel_width));total = (uint)(0);switch (kernel_width){
...
for (; (i) < (w); ++i) {
total -= (uint)(buffer[i & (8 - 1)]);pixels[i] = ((byte)(total / kernel_width));}pixels += stride_in_bytes;}
		}
...
for (; (i) < (h); ++i) {
total -= (uint)(buffer[i & (8 - 1)]);pixels[i * stride_in_bytes] = ((byte)(total / kernel_width));}pixels += 1;}
		}
...
int x0;int y0;int x1;int y1;int codepoint = (int)((ranges[i].array_of_unicode_codepoints) == (null)?ranges[i].first_unicode_codepoint_in_range + j:ranges[i].array_of_unicode_codepoints[j]);int glyph = (int)(stbtt_FindGlyphIndex(info, (int)(codepoint)));stbtt_GetGlyphBitmapBoxSubpixel(info, (int)(glyph), (float)(scale * spc->h_oversample), (float)(scale * spc->v_oversample), (float)(0), (float)(0), &x0, &y0, &x1, &y1);rects[k].w = ((int)(x1 - x0 + spc->padding + spc->h_oversample - 1));rects[k].h = ((int)(y1 - y0 + spc->padding + spc->v_oversample - 1));++k;}}
		...
		public static void stbtt_MakeGlyphBitmapSubpixelPrefilter(stbtt_fontinfo* info, byte* output, int out_w, int out_h, int out_stride, float scale_x, float scale_y, float shift_x, float shift_y, int prefilter_x, int prefilter_y, float* sub_x, float* sub_y, int glyph)
		{
			...
			if ((prefilter_x) > (1)) stbtt__h_prefilter(output, (int)(out_w), (int)(out_h), (int)(out_stride), (uint)(prefilter_x));
			if ((prefilter_y) > (1)) stbtt__v_prefilter(output, (int)(out_w), (int)(out_h), (int)(out_stride), (uint)(prefilter_y));
...
++k;}}
		...
		public static int stbtt_PackFontRanges(stbtt_pack_context* spc, byte* fontdata, int font_index, stbtt_pack_range* ranges, int num_ranges)
		{
			...
			int i;int j;int n;int return_value = (int)(1);
			stbrp_rect* rects;
...
q->x0 = (float)(*xpos + b->xoff);q->y0 = (float)(*ypos + b->yoff);q->x1 = (float)(*xpos + b->xoff2);q->y1 = (float)(*ypos + b->yoff2);}
		...
		public static int stbtt__ray_intersect_bezier(float* orig, float* ray, float* q0, float* q1, float* q2, float* hits)
		{
			...
			float s0 = (float)(0);float s1 = (float)(0);
			int num_s = (int)(0);
			if (a != 0.0) {
float discr = (float)(b * b - a * c);if ((discr) > (0.0)) {
float rcpna = (float)(-1 / a);float d = (float)(CRuntime.sqrt((double)(discr)));s0 = (float)((b + d) * rcpna);s1 = (float)((b - d) * rcpna);if (((s0) >= (0.0)) && (s0 <= 1.0)) num_s = (int)(1);if ((((d) > (0.0)) && ((s1) >= (0.0))) && (s1 <= 1.0)) {
if ((num_s) == (0)) s0 = (float)(s1);++num_s;}
}
}
 else {
s0 = (float)(c / (-2 * b));if (((s0) >= (0.0)) && (s0 <= 1.0)) num_s = (int)(1);}

			if ((num_s) == (0)) return (int)(0); else {
float rcp_len2 = (float)(1 / (ray[0] * ray[0] + ray[1] * ray[1]));float rayn_x = (float)(ray[0] * rcp_len2);float rayn_y = (float)(ray[1] * rcp_len2);float q0d = (float)(q0[0] * rayn_x + q0[1] * rayn_y);float q1d = (float)(q1[0] * rayn_x + q1[1] * rayn_y);float q2d = (float)(q2[0] * rayn_x + q2[1] * rayn_y);float rod = (float)(orig[0] * rayn_x + orig[1] * rayn_y);float q10d = (float)(q1d - q0d);float q20d = (float)(q2d - q0d);float q0rd = (float)(q0d - rod);hits[0] = (float)(q0rd + s0 * (2.0f - 2.0f * s0) * q10d + s0 * s0 * q20d);hits[1] = (float)(a * s0 + b);if ((num_s) > (1)) {
hits[2] = (float)(q0rd + s1 * (2.0f - 2.0f * s1) * q10d + s1 * s1 * q20d);hits[3] = (float)(a * s1 + b);return (int)(2);}
 else {
return (int)(1);}
}
		...
		{
			int i;
			float* orig = stackalloc float[2];float* ray = stackalloc float[2];
ray[0] = (float)(1);
ray[1] = (float)(0);
			...
			if ((y_frac) < (0.01f)) y += (float)(0.01f); else if ((y_frac) > (0.99f)) y -= (float)(0.01f);
			orig[1] = (float)(y);
			for (i = (int)(0); (i) < (nverts); ++i) {
if ((verts[i].type) == (STBTT_vline)) {
int x0 = (int)(verts[i - 1].x);int y0 = (int)(verts[i - 1].y);int x1 = (int)(verts[i].x);int y1 = (int)(verts[i].y);if ((((y) > ((y0) < (y1)?(y0):(y1))) && ((y) < ((y0) < (y1)?(y1):(y0)))) && ((x) > ((x0) < (x1)?(x0):(x1)))) {
float x_inter = (float)((y - y0) / (y1 - y0) * (x1 - x0) + x0);if ((x_inter) < (x)) winding += (int)(((y0) < (y1))?1:-1);}
}
if ((verts[i].type) == (STBTT_vcurve)) {
int x0 = (int)(verts[i - 1].x);int y0 = (int)(verts[i - 1].y);int x1 = (int)(verts[i].cx);int y1 = (int)(verts[i].cy);int x2 = (int)(verts[i].x);int y2 = (int)(verts[i].y);int ax = (int)((x0) < ((x1) < (x2)?(x1):(x2))?(x0):((x1) < (x2)?(x1):(x2)));int ay = (int)((y0) < ((y1) < (y2)?(y1):(y2))?(y0):((y1) < (y2)?(y1):(y2)));int by = (int)((y0) < ((y1) < (y2)?(y2):(y1))?((y1) < (y2)?(y2):(y1)):(y0));if ((((y) > (ay)) && ((y) < (by))) && ((x) > (ax))) {
float* q0 = stackalloc float[2];float* q1 = stackalloc float[2];float* q2 = stackalloc float[2];float* hits = stackalloc float[4];q0[0] = ((float)(x0));q0[1] = ((float)(y0));q1[0] = ((float)(x1));q1[1] = ((float)(y1));q2[0] = ((float)(x2));q2[1] = ((float)(y2));if (((equal(q0, q1)) != 0) || ((equal(q1, q2)) != 0)) {
x0 = ((int)(verts[i - 1].x));y0 = ((int)(verts[i - 1].y));x1 = ((int)(verts[i].x));y1 = ((int)(verts[i].y));if ((((y) > ((y0) < (y1)?(y0):(y1))) && ((y) < ((y0) < (y1)?(y1):(y0)))) && ((x) > ((x0) < (x1)?(x0):(x1)))) {
float x_inter = (float)((y - y0) / (y1 - y0) * (x1 - x0) + x0);if ((x_inter) < (x)) winding += (int)(((y0) < (y1))?1:-1);}
}
 else {
int num_hits = (int)(stbtt__ray_intersect_bezier(orig, ray, q0, q1, q2, hits));if ((num_hits) >= (1)) if ((hits[0]) < (0)) winding += (int)((hits[1]) < (0)?-1:1);if ((num_hits) >= (2)) if ((hits[2]) < (0)) winding += (int)((hits[3]) < (0)?-1:1);}
}
}
}
			return (int)(winding);
		...
		{
			if ((x) < (0)) return (float)(-(float)(CRuntime.pow((double)(-x), (double)(1.0f / 3.0f)))); else return (float)(CRuntime.pow((double)(x), (double)(1.0f / 3.0f)));
		}
		...
		public static int stbtt__solve_cubic(float a, float b, float c, float* r)
		{
			...
			if ((d) >= (0)) {
float z = (float)(CRuntime.sqrt((double)(d)));float u = (float)((-q + z) / 2);float v = (float)((-q - z) / 2);u = (float)(stbtt__cuberoot((float)(u)));v = (float)(stbtt__cuberoot((float)(v)));r[0] = (float)(s + u + v);return (int)(1);}
 else {
float u = (float)(CRuntime.sqrt((double)(-p / 3)));float v = (float)((float)(CRuntime.acos((double)(-CRuntime.sqrt((double)(-27 / p3)) * q / 2))) / 3);float m = (float)(CRuntime.cos((double)(v)));float n = (float)((float)(CRuntime.cos((double)(v - 3.141592 / 2))) * 1.732050808f);r[0] = (float)(s + u * 2 * m);r[1] = (float)(s - u * (m + n));r[2] = (float)(s - u * (m - n));return (int)(3);}
		...
		{
			float scale_x = (float)(scale);float scale_y = (float)(scale);
			int ix0;int iy0;int ix1;int iy1;
			int w;int h;
			byte* data;
			if ((scale_x) == (0)) scale_x = (float)(scale_y);
...
if ((scale_x) == (0)) return (null);scale_y = (float)(scale_x);}
			...
			{
int x;int y;int i;int j;float* precompute;stbtt_vertex* verts;int num_verts = (int)(stbtt_GetGlyphShape(info, (int)(glyph), &verts));data = (byte*)(CRuntime.malloc((ulong)(w * h)));precompute = (float*)(CRuntime.malloc((ulong)(num_verts * sizeof(float))));for (i = (int)(0) , j = (int)(num_verts - 1); (i) < (num_verts); j = (int)(i++)) {
if ((verts[i].type) == (STBTT_vline)) {
float x0 = (float)(verts[i].x * scale_x);float y0 = (float)(verts[i].y * scale_y);float x1 = (float)(verts[j].x * scale_x);float y1 = (float)(verts[j].y * scale_y);float dist = (float)(CRuntime.sqrt((double)((x1 - x0) * (x1 - x0) + (y1 - y0) * (y1 - y0))));precompute[i] = (float)(((dist) == (0))?0.0f:1.0f / dist);}
 else if ((verts[i].type) == (STBTT_vcurve)) {
float x2 = (float)(verts[j].x * scale_x);float y2 = (float)(verts[j].y * scale_y);float x1 = (float)(verts[i].cx * scale_x);float y1 = (float)(verts[i].cy * scale_y);float x0 = (float)(verts[i].x * scale_x);float y0 = (float)(verts[i].y * scale_y);float bx = (float)(x0 - 2 * x1 + x2);float by = (float)(y0 - 2 * y1 + y2);float len2 = (float)(bx * bx + by * by);if (len2 != 0.0f) precompute[i] = (float)(1.0f / (bx * bx + by * by)); else precompute[i] = (float)(0.0f);}
 else precompute[i] = (float)(0.0f);}for (y = (int)(iy0); (y) < (iy1); ++y) {
for (x = (int)(ix0); (x) < (ix1); ++x) {
float val;float min_dist = (float)(999999.0f);float sx = (float)((float)(x) + 0.5f);float sy = (float)((float)(y) + 0.5f);float x_gspace = (float)(sx / scale_x);float y_gspace = (float)(sy / scale_y);int winding = (int)(stbtt__compute_crossings_x((float)(x_gspace), (float)(y_gspace), (int)(num_verts), verts));for (i = (int)(0); (i) < (num_verts); ++i) {
float x0 = (float)(verts[i].x * scale_x);float y0 = (float)(verts[i].y * scale_y);float dist2 = (float)((x0 - sx) * (x0 - sx) + (y0 - sy) * (y0 - sy));if ((dist2) < (min_dist * min_dist)) min_dist = ((float)(CRuntime.sqrt((double)(dist2))));if ((verts[i].type) == (STBTT_vline)) {
float x1 = (float)(verts[i - 1].x * scale_x);float y1 = (float)(verts[i - 1].y * scale_y);float dist = (float)((float)(CRuntime.fabs((double)((x1 - x0) * (y0 - sy) - (y1 - y0) * (x0 - sx)))) * precompute[i]);if ((dist) < (min_dist)) {
float dx = (float)(x1 - x0);float dy = (float)(y1 - y0);float px = (float)(x0 - sx);float py = (float)(y0 - sy);float t = (float)(-(px * dx + py * dy) / (dx * dx + dy * dy));if (((t) >= (0.0f)) && (t <= 1.0f)) min_dist = (float)(dist);}
}
 else if ((verts[i].type) == (STBTT_vcurve)) {
float x2 = (float)(verts[i - 1].x * scale_x);float y2 = (float)(verts[i - 1].y * scale_y);float x1 = (float)(verts[i].cx * scale_x);float y1 = (float)(verts[i].cy * scale_y);float box_x0 = (float)(((x0) < (x1)?(x0):(x1)) < (x2)?((x0) < (x1)?(x0):(x1)):(x2));float box_y0 = (float)(((y0) < (y1)?(y0):(y1)) < (y2)?((y0) < (y1)?(y0):(y1)):(y2));float box_x1 = (float)(((x0) < (x1)?(x1):(x0)) < (x2)?(x2):((x0) < (x1)?(x1):(x0)));float box_y1 = (float)(((y0) < (y1)?(y1):(y0)) < (y2)?(y2):((y0) < (y1)?(y1):(y0)));if (((((sx) > (box_x0 - min_dist)) && ((sx) < (box_x1 + min_dist))) && ((sy) > (box_y0 - min_dist))) && ((sy) < (box_y1 + min_dist))) {
int num = (int)(0);float ax = (float)(x1 - x0);float ay = (float)(y1 - y0);float bx = (float)(x0 - 2 * x1 + x2);float by = (float)(y0 - 2 * y1 + y2);float mx = (float)(x0 - sx);float my = (float)(y0 - sy);float* res = stackalloc float[3];float px;float py;float t;float it;float a_inv = (float)(precompute[i]);if ((a_inv) == (0.0)) {
float a = (float)(3 * (ax * bx + ay * by));float b = (float)(2 * (ax * ax + ay * ay) + (mx * bx + my * by));float c = (float)(mx * ax + my * ay);if ((a) == (0.0)) {
if (b != 0.0) {
res[num++] = (float)(-c / b);}
}
 else {
float discriminant = (float)(b * b - 4 * a * c);if ((discriminant) < (0)) num = (int)(0); else {
float root = (float)(CRuntime.sqrt((double)(discriminant)));res[0] = (float)((-b - root) / (2 * a));res[1] = (float)((-b + root) / (2 * a));num = (int)(2);}
}
}
 else {
float b = (float)(3 * (ax * bx + ay * by) * a_inv);float c = (float)((2 * (ax * ax + ay * ay) + (mx * bx + my * by)) * a_inv);float d = (float)((mx * ax + my * ay) * a_inv);num = (int)(stbtt__solve_cubic((float)(b), (float)(c), (float)(d), res));}
if ((((num) >= (1)) && ((res[0]) >= (0.0f))) && (res[0] <= 1.0f)) {
t = (float)(res[0]);it = (float)(1.0f - t);px = (float)(it * it * x0 + 2 * t * it * x1 + t * t * x2);py = (float)(it * it * y0 + 2 * t * it * y1 + t * t * y2);dist2 = (float)((px - sx) * (px - sx) + (py - sy) * (py - sy));if ((dist2) < (min_dist * min_dist)) min_dist = ((float)(CRuntime.sqrt((double)(dist2))));}
if ((((num) >= (2)) && ((res[1]) >= (0.0f))) && (res[1] <= 1.0f)) {
t = (float)(res[1]);it = (float)(1.0f - t);px = (float)(it * it * x0 + 2 * t * it * x1 + t * t * x2);py = (float)(it * it * y0 + 2 * t * it * y1 + t * t * y2);dist2 = (float)((px - sx) * (px - sx) + (py - sy) * (py - sy));if ((dist2) < (min_dist * min_dist)) min_dist = ((float)(CRuntime.sqrt((double)(dist2))));}
if ((((num) >= (3)) && ((res[2]) >= (0.0f))) && (res[2] <= 1.0f)) {
t = (float)(res[2]);it = (float)(1.0f - t);px = (float)(it * it * x0 + 2 * t * it * x1 + t * t * x2);py = (float)(it * it * y0 + 2 * t * it * y1 + t * t * y2);dist2 = (float)((px - sx) * (px - sx) + (py - sy) * (py - sy));if ((dist2) < (min_dist * min_dist)) min_dist = ((float)(CRuntime.sqrt((double)(dist2))));}
}
}
}if ((winding) == (0)) min_dist = (float)(-min_dist);val = (float)(onedge_value + pixel_dist_scale * min_dist);if ((val) < (0)) val = (float)(0); else if ((val) > (255)) val = (float)(255);data[(y - iy0) * w + (x - ix0)] = ((byte)(val));}}CRuntime.free(precompute);CRuntime.free(verts);}
...
uint c;ushort ch2 = (ushort)(s2[2] * 256 + s2[3]);if ((i + 3) >= (len1)) return (int)(-1);c = (uint)(((ch - 0xd800) << 10) + (ch2 - 0xdc00) + 0x10000);if (s1[i++] != 0xf0 + (c >> 18)) return (int)(-1);if (s1[i++] != 0x80 + ((c >> 12) & 0x3f)) return (int)(-1);if (s1[i++] != 0x80 + ((c >> 6) & 0x3f)) return (int)(-1);if (s1[i++] != 0x80 + ((c) & 0x3f)) return (int)(-1);s2 += 2;len2 -= (int)(2);}
...
s2 += 2;len2 -= (int)(2);}
		...
		{
			int i;int count;int stringOffset;
			byte* fc = font->data;
...
++matchlen;if ((stbtt_CompareUTF8toUTF16_bigendian_internal((sbyte*)(name + matchlen), (int)(nlen - matchlen), (sbyte*)(fc + stringOffset + off), (int)(slen))) != 0) return (int)(1);}
}
 else {
if ((matchlen) == (nlen)) return (int)(1);}
}
