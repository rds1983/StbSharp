...
namespace StbSharp
{
	public static unsafe partial class Stb
	{
		...
		private static ArrayPointer<uint> crc_table =
									...
									for (i = (int) (0); (i) < (n); ++i)
									{
										switch (type)
										{
											...
											case 3:
												...
												break;
											case 4:
												line_buffer[i] = (sbyte) ((sbyte) (z[i] - stbiw__paeth((int) (0), (int) (z[i - stride_bytes]), (int) (0))));
												break;
											case 5:
												line_buffer[i] = (sbyte) (z[i]);
												break;
									...
									{
										{
											switch (type)
											{
												...
												case 4:
													line_buffer[i] =
														(sbyte)
															(z[i] - stbiw__paeth((int) (z[i - n]), (int) (z[i - stride_bytes]), (int) (z[i - stride_bytes - n])));
													break;
												case 5:
